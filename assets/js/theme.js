let toggleThemeSetting = () => {
  ...
  setThemeSetting = (e) => {
    (localStorage.setItem("theme", e), document.documentElement.setAttribute("data-theme-setting", e), applyTheme());
  },
  applyTheme = () => {
    ...
    for (let o = 0; o < t.length; o++) "dark" == e ? t[o].classList.add("table-dark") : t[o].classList.remove("table-dark");
    let o = document.getElementsByClassName("jupyter-notebook-iframe-container");
    for (let t = 0; t < o.length; t++) {
      let r = o[t].getElementsByTagName("iframe")[0].contentWindow.document.body;
      "dark" == e
        ? (r.setAttribute("data-jp-theme-light", "false"), r.setAttribute("data-jp-theme-name", "JupyterLab Dark"))
        : (r.setAttribute("data-jp-theme-light", "true"), r.setAttribute("data-jp-theme-name", "JupyterLab Light"));
    }
  ...
  setHighlight = (e) => {
    "dark" == e
      ? ((document.getElementById("highlight_theme_light").media = "none"), (document.getElementById("highlight_theme_dark").media = ""))
  ...
  addMermaidZoom = (e, t) => {
    (d3.selectAll(".mermaid svg").each(function () {
      ...
      e.html("<g>" + e.html() + "</g>");
      var t = e.select("g"),
        o = d3.zoom().on("zoom", function (e) {
          t.attr("transform", e.transform);
        });
      e.call(o);
    }),
      t.disconnect());
  ...
  setMermaidTheme = (e) => {
    ("light" == e && (e = "default"),
      document.querySelectorAll(".mermaid").forEach((e) => {
        let t = e.previousSibling.childNodes[0].innerHTML;
        (e.removeAttribute("data-processed"), (e.innerHTML = t));
      }),
      mermaid.initialize({ theme: e }),
      window.mermaid.init(void 0, document.querySelectorAll(".mermaid")));
    const t = document.querySelector(".mermaid svg");
    if (null !== t) {
      const e = { childList: !0 };
      new MutationObserver(addMermaidZoom).observe(t, e);
    }
  },
  setDiff2htmlTheme = (e) => {
    document.querySelectorAll(".diff2html").forEach((t) => {
      let o = t.previousSibling.childNodes[0].innerHTML;
      t.innerHTML = "";
      new Diff2HtmlUI(t, o, { colorScheme: e, drawFileList: !0, highlight: !0, matching: "lines" }).draw();
    });
  },
  setEchartsTheme = (e) => {
    document.querySelectorAll(".echarts").forEach((t) => {
      let o = t.previousSibling.childNodes[0].innerHTML;
      if ((echarts.dispose(t), "dark" === e)) var r = echarts.init(t, "dark-fresh-cut");
      else r = echarts.init(t);
      r.setOption(JSON.parse(o));
    });
  },
  setPlotlyTheme = (e) => {
    document.querySelectorAll(".js-plotly-plot").forEach((t) => {
      let o = JSON.parse(t.previousSibling.childNodes[0].innerHTML);
      if ("dark" === e) {
        const e = {
          layout: {
          ...
          data: {
            ...
            scatter3d: [
              { type: "scatter3d", line: { colorbar: { outlinewidth: 0, ticks: "" } }, marker: { colorbar: { outlinewidth: 0, ticks: "" } } },
            ],
        ...
        o.layout
          ? o.layout.template
            ? (o.layout.template = { ...e, ...o.layout.template })
            : (o.layout.template = e)
          : (o.layout = { template: e });
      } else {
        const e = {
          layout: {
            ...
            geo: { bgcolor: "white", landcolor: "white", subunitcolor: "#C8D4E3", showland: !0, showlakes: !0, lakecolor: "white" },
            title: { x: 0.05 },
            mapbox: { style: "light" },
          },
          data: {
            ...
            barpolar: [
              { marker: { line: { color: "white", width: 0.5 }, pattern: { fillmode: "overlay", size: 10, solidity: 0.2 } }, type: "barpolar" },
            ],
            pie: [{ automargin: !0, type: "pie" }],
          },
        };
      ...
      Plotly.relayout(t, o.layout);
    });
  },
  setVegaLiteTheme = (e) => {
    document.querySelectorAll(".vega-lite").forEach((t) => {
      let o = t.previousSibling.childNodes[0].innerHTML;
      ((t.innerHTML = ""), "dark" === e ? vegaEmbed(t, JSON.parse(o), { theme: "dark" }) : vegaEmbed(t, JSON.parse(o)));
    });
  },
  setSearchTheme = (e) => {
    const t = document.querySelector("ninja-keys");
    t && ("dark" === e ? t.classList.add("dark") : t.classList.remove("dark"));
  },
  setCookieConsentTheme = (e) => {
    var t = document.documentElement;
    "dark" === e ? t.classList.add("cc--darkmode") : t.classList.remove("cc--darkmode");
  },
  transTheme = () => {
  ...
  determineThemeSetting = () => {
    ...
    return ("dark" != e && "light" != e && "system" != e && (e = "system"), e);
  },
  ...
  getCalendarBgColor = () => ("dark" === determineComputedTheme() ? "333333" : "f9f9f9"),
  getCalendarUrl = (e, t = "UTC") =>
    `${"https://calendar.google.com/calendar/embed"}?${new URLSearchParams({ src: e, ctz: t, mode: "WEEK", showTitle: "0", showPrint: "0", showCalendars: "0", showTabs: "0", bgcolor: getCalendarBgColor() }).toString()}`,
  updateCalendarUrl = () => {
    const e = document.getElementById("calendar-iframe");
    e && e.dataset.calendarId && (e.src = getCalendarUrl(e.dataset.calendarId, e.dataset.timezone || "UTC"));
  };
