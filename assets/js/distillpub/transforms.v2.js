!(function (e, t) {
    ...
    ((e.title = t.title),
      t.published &&
        (t.published instanceof Date
          ...
          : t.published.constructor === String && (e.publishedDate = new Date(t.published))),
      t.publishedDate &&
        (t.publishedDate instanceof Date
          ? (e.publishedDate = t.publishedDate)
          : t.publishedDate.constructor === String && (e.publishedDate = new Date(t.publishedDate))),
    ...
    for (let t of e.authors) {
      ...
      if (e)
        if (n);
          ...
          (t.affiliationURL && (e.url = t.affiliationURL), (t.affiliations = [e]));
        }
    }
    return e;
  }
  ...
  function c(e) {
    const t = new Map(),
      n = re.toJSON(e);
    for (const e of n) {
      for (const [t, n] of Object.entries(e.entryTags)) e.entryTags[t.toLowerCase()] = u(n);
  ...
  function h(e) {
    ...
    if (t && "SCRIPT" === t.tagName) {
      if ("text/bibtex" == t.type) {
        return c(e.firstElementChild.textContent);
      }
  ...
  function p(e, n) {
    ...
    if (i) {
      const a = n.inputDirectory + "/" + i,
        o = c(t.readFileSync(a, "utf-8")),
        s = e.createElement("script");
      ((s.type = "text/json"), (s.textContent = JSON.stringify([...o])), r.appendChild(s), r.removeAttribute("src"));
    }
    n.bibliography = h(r);
  }
  // Copyright 2018 The Distill Template Authors
  function f(e = document) {
    ...
    for (const e of n) {
      const n = (e.getAttribute("key") || e.getAttribute("bibtex-key")).split(",").map((e) => e.trim());
    ...
    let a = i.map((e) => {
      if (-1 != (e = e.trim()).indexOf(","))
        var n = e.split(",")[0].trim(),
          r = e.split(",")[1];
      else if (-1 != e.indexOf(" ")) ((n = e.split(" ").slice(-1)[0].trim()), (r = e.split(" ").slice(0, -1).join(" ")));
      else n = e.trim();
      var i = "";
      return (
        null != r &&
  ...
  function v(e) {
    if ("url" in e) {
      ...
      if ((null != n && (t = `http://arxiv.org/pdf/${n[1]}.pdf`), ".pdf" == t.slice(-4))) var r = "PDF";
  ...
  function b(e, t) {
    return "doi" in e ? `${t ? "<br>" : ""} <a href="https://doi.org/${e.doi}" style="text-decoration:inherit;">DOI: ${e.doi}</a>` : "";
  }
  function y(e) {
  ...
  function x(e) {
    if (e) {
      ...
      return (
        (t += v(e) + "<br>"),
        e.author && ((t += m(e, "${L}, ${I}", ", ", " and ")), (e.year || e.date) && (t += ", ")),
  ...
  function k(e) {
    ...
    if ((e.querySelector("html").getAttribute("lang") || e.querySelector("html").setAttribute("lang", "en"), !e.querySelector("meta[charset]"))) {
      const n = e.createElement("meta");
      (n.setAttribute("charset", "utf-8"), t.appendChild(n));
    }
    if (!e.querySelector("meta[name=viewport]")) {
      const n = e.createElement("meta");
      (n.setAttribute("name", "viewport"), n.setAttribute("content", "width=device-width, initial-scale=1"), t.appendChild(n));
    }
  }
  // Copyright 2018 The Distill Template Authors
  function M(e) {
  ...
  function z(e, t) {
    ...
    i || (t.authors && ((i = e.createElement("d-byline")), n.insertBefore(i, r)));
    let a = e.querySelector("d-title");
    a || ((a = e.createElement("d-title")), n.insertBefore(a, i));
    let o = a.querySelector("h1");
    o || ((o = e.createElement("h1")), (o.textContent = t.title), a.insertBefore(o, a.firstChild));
    const s = void 0 !== t.password;
    let l = n.querySelector("d-interstitial");
    if (s && !l) {
      const r = "undefined" != typeof window,
        i = r && window.location.hostname.includes("localhost");
      (r && i) || ((l = e.createElement("d-interstitial")), (l.password = t.password), n.insertBefore(l, n.firstChild));
    ...
    let c = e.querySelector("d-footnote-list");
    c || ((c = e.createElement("d-footnote-list")), u.appendChild(c));
    let d = e.querySelector("d-citation-list");
    d || ((d = e.createElement("d-citation-list")), u.appendChild(d));
  }
  // Copyright 2018 The Distill Template Authors
  function A(e, t) {
    let n = !1;
    ...
    if (!r) return;
    t.katex && t.katex.delimiters && ((global.document = e), he(r, t.katex));
    ...
    if (i.length > 0) {
      ...
      for (const n of i) {
        const r = { displayMode: n.hasAttribute("block") },
          ...
          a = ae.renderToString(n.textContent, i),
          o = e.createElement("span");
        ((o.innerHTML = a), n.parentElement.insertBefore(o, n), n.parentElement.removeChild(n));
      }
    }
    if (n) {
      const t = '<link rel="stylesheet" href="https://distill.pub/third-party/katex/katex.min.css" crossorigin="anonymous">';
  ...
  function T(e, t) {
    function n(e, t, n) {
      (t || n) && i(`    <meta name="${e}" content="${me(t)}" >\n`);
    }
    ...
    if (
      ...
      (t.authors || []).forEach((e) => {
        N(r, `\n    <meta property="article:author" content="${me(e.firstName)} ${me(e.lastName)}" />`);
      }),
      i(
      ...
      (i("\n      <!--  https://scholar.google.com/intl/en/scholar/inclusion.html#indexing -->\n"),
        ...
        n("citation_firstpage", t.doiSuffix ? `e${t.doiSuffix}` : void 0),
      ...
      (n("citation_journal_title", e.full_title || e.title),
        ...
        t.publishedDate &&
          (n("citation_online_date", `${t.publishedYear}/${t.publishedMonthPadded}/${t.publishedDayPadded}`),
          n("citation_publication_date", `${t.publishedYear}/${t.publishedMonthPadded}/${t.publishedDayPadded}`)),
        (t.authors || []).forEach((e) => {
          (n("citation_author", `${e.lastName}, ${e.firstName}`), n("citation_author_institution", e.affiliation));
        }));
    }
    t.citations &&
  ...
  function E(e) {
    ...
    (e.author &&
      ...
      e.author.split(" and ").forEach((e) => {
        ...
        (-1 != (e = e.trim()).indexOf(",")
          ...
          : ((n = e.split(" ").slice(-1)[0].trim()), (r = e.split(" ").slice(0, -1).join(" "))),
    ...
    return (
      ...
      (n = n || /arXiv preprint arXiv:([0-9]*\.[0-9]*)/.exec(e.journal)),
      n && n[1]
        ? (t += `citation_arxiv_id=${n[1]};`)
        : ("journal" in e && (t += `citation_journal_title=${me(e.journal)};`),
          "volume" in e && (t += `citation_volume=${me(e.volume)};`),
          ("issue" in e || "number" in e) && (t += `citation_number=${me(e.issue || e.number)};`),
          t)
    );
  }
  function R(e) {
  ...
  function L(e, t) {
    ...
    for (const e of t) {
      ...
      let a = '<li><a href="' + ("#" + e.getAttribute("id")) + '">' + i + "</a></li>";
  ...
  // Copyright 2018 The Distill Template Authors
  function q(e) {
    for (var t = e.createTreeWalker(e.body, e.defaultView.NodeFilter.SHOW_TEXT); t.nextNode(); ) {
      var n = t.currentNode,
        r = n.nodeValue;
  ...
  function _(e) {
    var t = e.parentElement,
      n =
        ...
        (t.getAttribute("class").includes("katex") || t.getAttribute("class").includes("MathJax"));
    return (
      t &&
      "SCRIPT" !== t.nodeName &&
      "STYLE" !== t.nodeName &&
   ...
   */ function D(e) {
    var t = "\xa0",
      n = /([\xab\xbf\xa1]) /g,
      r = / ([!?:;.,\u203d\xbb])/g;
    return (e = (e = (e = (e = (e = e.replace(/--/g, "\u2014")).replace(/\s*\u2014\s*/g, "\u2009\u2014\u2009")).replace(/\.\.\./g, "\u2026")).replace(
      n,
      "$1" + t
    )).replace(r, t + "$1"));
  }
  ...
  function I(e) {
    ...
    ((n.src = "https://cdnjs.cloudflare.com/ajax/libs/webcomponentsjs/1.0.17/webcomponents-loader.js"), e.head.insertBefore(n, e.head.firstChild));
    const r = e.createElement("script");
    ((r.innerHTML = ve), e.head.insertBefore(r, e.head.firstChild));
  }
  // Copyright 2018 The Distill Template Authors
  function H(e, t, n = document) {
    if (t.size > 0) {
      ...
      if (r) r.innerHTML = "";
        ...
        ((t.innerHTML = be), e.appendChild(t));
        const i = n.createElement("h3");
        ((i.id = "references"),
          (i.textContent = "References"),
          e.appendChild(i),
          (r = n.createElement("ol")),
          (r.id = "references-list"),
  ...
  function P(e, t) {
    ...
    if (n) {
      (H(n, new Map(t.citations.map((e) => [e, t.bibliography.get(e)])), e), n.setAttribute("distill-prerendered", "true"));
    }
  }
  // Copyright 2018 The Distill Template Authors
  function j(e) {
  ...
  function F(e) {
    if (!e.querySelector("distill-header")) {
      ...
      ((t.innerHTML = xe), t.setAttribute("distill-prerendered", ""));
  ...
  function $(e) {
    ...
    void 0 !== e.githubUrl &&
      ...
      e.githubCompareUpdatesUrl && (t += `<a href="${e.githubCompareUpdatesUrl}">View all changes</a> to this article since it was first published.`),
  ...
  function Y(e) {
    if (!e.querySelector("distill-footer")) {
      ...
      t.innerHTML = ke;
      e.querySelector("body").appendChild(t);
    }
  }
  // Copyright 2018 The Distill Template Authors
  function V(e, t, n = !0) {
    ...
    for (const [t, i] of Me.entries()) i(e, r, n);
    for (const [t, i] of Se.entries()) i(e, r, n);
    (e.body.setAttribute("distill-prerendered", ""), t instanceof ne || r.assignToObject(t));
  }
  function G(e, t, n = !0) {
    for (const [r, i] of ze.entries()) i(e, t, n);
  }
  function W(e) {
    ...
    for (const e of t) {
      ...
      else if (t.includes("template.")) throw new Error("Uses distill template, but unknown version?!");
    }
    if (void 0 === n) throw new Error("Does not seem to use Distill template at all.");
    return n;
  }
  ...
  const K = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
    ...
    Q = function (e) {
      return Array.from(e).reduce((e, [t, n]) => Object.assign(e, { [t]: n }), {});
    },
    ee = function (e) {
      const t = new Map();
  ...
  class ne {
    ...
    get volume() {
      ...
      if (e < 1) throw new Error("Invalid publish date detected during computing volume");
      return e;
    }
    get issue() {
    ...
    get bibtexAuthors() {
      return this.authors.map((e) => e.lastName + ", " + e.firstName).join(" and ");
    }
    get slug() {
      let e = "";
      return (
        this.authors.length &&
          ((e += this.authors[0].lastName.toLowerCase()), (e += this.publishedYear), (e += this.title.split(" ")[0].toLowerCase())),
        e || "Untitled"
      );
    }
    get bibliographyEntries() {
      return new Map(this.citations.map((e) => [e, this.bibliography.get(e)]));
    }
    set bibliography(e) {
      e instanceof Map ? (this._bibliography = e) : "object" == typeof e && (this._bibliography = ee(e));
    }
    get bibliography() {
        ...
        function t() {
          ((this.months = ["jan", "feb", "mar", "apr", "may", "jun", "jul", "aug", "sep", "oct", "nov", "dec"]),
            ...
            (this.match = function (e, t) {
              if (((null != t && null != t) || (t = !0), this.skipWhitespace(t), this.input.substring(this.pos, this.pos + e.length) != e))
                throw "Token mismatch, expected " + e + ", found " + this.input.substring(this.pos);
              ((this.pos += e.length), this.skipWhitespace(t));
            }),
            (this.tryMatch = function (e, t) {
              return ((null != t && null != t) || (t = !0), this.skipWhitespace(t), this.input.substring(this.pos, this.pos + e.length) == e);
            }),
            (this.matchAt = function () {
              for (; this.input.length > this.pos && "@" != this.input[this.pos]; ) this.pos++;
            ...
            (this.value_quotes = function () {
              ...
              for (var e = this.pos, t = !1; ; ) {
                if (!t) {
                  ...
                  if (this.pos >= this.input.length - 1) throw "Unterminated value:" + this.input.substring(e);
                }
            ...
            (this.single_value = function () {
              ...
              if (this.months.indexOf(t.toLowerCase()) >= 0) return t.toLowerCase();
              throw "Value expected:" + this.input.substring(e) + " for key: " + t;
            }),
            (this.value = function () {
              var e = [];
              for (e.push(this.single_value()); this.tryMatch("#"); ) (this.match("#"), e.push(this.single_value()));
              return e.join("");
            }),
            (this.key = function () {
              for (var e = this.pos; ; ) {
                if (this.pos >= this.input.length) throw "Runaway key";
                if (this.notKey.indexOf(this.input[this.pos]) >= 0) return this.input.substring(e, this.pos);
                this.pos++;
              }
            }),
            ...
            (this.key_value_list = function () {
              ...
              for (
                this.currentEntry.entryTags = {}, this.currentEntry.entryTags[e[0]] = e[1];
                this.tryMatch(",") && (this.match(","), !this.tryMatch("}"));
              )
                ((e = this.key_equals_value()), (this.currentEntry.entryTags[e[0]] = e[1]));
            }),
            ...
            (this.bibtex = function () {
              for (; this.matchAt(); ) {
                ...
                (this.match("{"),
                  "@STRING" == e ? this.string() : "@PREAMBLE" == e ? this.preamble() : "@COMMENT" == e ? this.comment() : this.entry(e),
                  this.match("}"));
              }
            }));
        }
          ...
          (e.toBibtex = function (e) {
            ...
            for (var n in e) {
              if (
                ...
                var r = "";
                for (var i in e[n].entryTags) (0 != r.length && (r += ", "), (r += i + "= {" + e[n].entryTags[i] + "}"));
                t += r;
              }
              t += "}\n\n";
            }
    ...
    ie = l(function (e) {
      ...
      ((t = function () {
        return (function e(t, n, r) {
          ...
          for (var a = "function" == typeof o && o, s = 0; s < r.length; s++) i(r[s]);
          return i;
        })(
          {
            1: [
              function (e, t) {
                ...
                "undefined" != typeof document &&
                  ...
                  (l = function () {
                    throw new r.default("KaTeX doesn't work in quirks mode.");
                  });
                var u = function (e, t) {
                ...
                t.exports = { render: l, renderToString: u, __parse: c, ParseError: r.default };
              },
              { "./src/ParseError": 29, "./src/Settings": 32, "./src/buildTree": 37, "./src/parseTree": 46, "./src/utils": 51 },
            ],
            2: [
              function (e, t) {
                            ...
                            : g && c
                              ...
                              : v && x[u] == d
                                ...
                                : m && "function" == typeof d
                                  ? i(Function.call, d)
                                  : d),
                        m && (((b.virtual || (b.virtual = {}))[u] = d), e & s.R && y && !y[u] && a(y, u, d)));
                  };
              ...
              function (e, t) {
                function n(e) {
                  if (!e.__matchAtRelocatable) {
                    var t = e.source + "|()",
                      n = "g" + (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "");
                ...
                t.exports = r()
                  ...
                  : function (e, t) {
                      for (var r, o, s = n(e), l = 1; l < arguments.length; l++) {
                        for (var u in (r = Object(arguments[l]))) i.call(r, u) && (s[u] = r[u]);
            ...
            26: [
              function (e, t) {
                ...
                var r = n(e("babel-runtime/helpers/classCallCheck")),
                  ...
                  s = (function () {
                    function e(t, n, i, a) {
                      ((0, r.default)(this, e), (this.text = t), (this.start = n), (this.end = i), (this.lexer = a));
                    }
                    return (
                      (0, i.default)(e, [
                        {
                          key: "range",
                          value: function (t, n) {
                            return t.lexer !== this.lexer ? new e(n) : new e(n, this.start, t.end, this.lexer);
                          },
                        },
                      ]),
                      e
                  ...
                  u = (function () {
                    function e(t) {
                      ((0, r.default)(this, e), (this.input = t), (this.pos = 0));
                    }
                    return (
                      (0, i.default)(e, [
                        {
                          ...
                          value: function () {
                            var e = this.input,
                              t = this.pos;
                            if (t === e.length) return new s("EOF", t, t, this);
                            var n = (0, a.default)(l, e, t);
                            if (null === n) throw new o.default("Unexpected character: '" + e[t] + "'", new s(e[t], t, t + 1, this));
                            var r = n[2] || " ",
                              i = this.pos;
                            this.pos += n[0].length;
                            var u = this.pos;
              ...
              { "./ParseError": 29, "babel-runtime/helpers/classCallCheck": 4, "babel-runtime/helpers/createClass": 5, "match-at": 24 },
            ],
            27: [
              function (e, t) {
                function n(e) {
                  ...
                  u = (function () {
                    function e(t, n) {
                      ((0, r.default)(this, e),
                        ...
                        (this.macros = (0, l.default)({}, o.default, n)),
                        (this.stack = []),
                      ...
                      (0, i.default)(e, [
                        {
                          ...
                          value: function () {
                            for (;;) {
                              ...
                              if ("string" == typeof r) {
                                var i = 0;
                                if (-1 !== r.indexOf("#")) for (var o = r.replace(/##/g, ""); -1 !== o.indexOf("#" + (i + 1)); ) ++i;
                                var l = new a.default(r);
                                for (r = [], n = l.lex(); "EOF" !== n.text; ) (r.push(n), (n = l.lex()));
                                (r.reverse(), (r.numArgs = i), (this.macros[t] = r));
                              }
                              if (r.numArgs) {
                                var u = [],
                                  c = void 0;
                                for (c = 0; c < r.numArgs; ++c) {
                                  var d = this.get(!0);
                                  if ("{" === d.text) {
                                    for (var h = [], p = 1; 0 !== p; )
                                      if (((n = this.get(!1)), h.push(n), "{" === n.text)) ++p;
                                      else if ("}" === n.text) --p;
                                      else if ("EOF" === n.text) throw new s.default("End of input in macro argument", d);
                                    (h.pop(), h.reverse(), (u[c] = h));
                                  } else {
                                    if ("EOF" === d.text) throw new s.default("End of input expecting macro argument", e);
                                    u[c] = [d];
                                  }
                                }
                                for (c = (r = r.slice()).length - 1; c >= 0; --c)
                                  if ("#" === (n = r[c]).text) {
                                    if (0 === c) throw new s.default("Incomplete placeholder at end of macro body", n);
                                    if ("#" === (n = r[--c]).text) r.splice(c + 1, 1);
                                    else {
                                      if (!/^[1-9]$/.test(n.text)) throw new s.default("Not a valid argument number", n);
                                      r.splice.apply(r, [c, 2].concat(u[n.text - 1]));
                                    }
                                  }
                              }
            ...
            28: [
              function (e, t) {
                ...
                var r = n(e("babel-runtime/helpers/classCallCheck")),
                  ...
                  l = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
                  u = function (e, t) {
                    ...
                    return (
                      (0, i.default)(e, [
                        ...
                        },
                        {
                          key: "havingStyle",
                          value: function (e) {
                            return this.style === e ? this : this.extend({ style: e, size: u(this.textSize, e) });
                          },
                        },
                        {
                        ...
                        },
                        {
                          key: "havingSize",
                          value: function (e) {
                            return this.size === e && this.textSize === e ? this : this.extend({ style: this.style.text(), size: e, textSize: e });
                          },
                        },
                        {
                          key: "havingBaseStyle",
                          value: function (e) {
                            e = e || this.style.text();
                            var t = u(o, e);
                            return this.size === t && this.textSize === o && this.style === e
                              ? this
                              : this.extend({ style: e, size: t, baseSize: o });
                          },
                        },
                        {
                          key: "withColor",
                        ...
                        },
                        {
                          ...
                          value: function () {
                            return this.size !== o ? ["sizing", "reset-size" + this.size, "size" + o] : [];
                          },
                        },
                        {
                          key: "fontMetrics",
                          value: function () {
                            return (this._fontMetrics || (this._fontMetrics = a.default.getFontMetrics(this.size)), this._fontMetrics);
                          },
                        },
                        {
                          key: "getColor",
                          value: function () {
                            return this.phantom ? "transparent" : e.colorMap[this.color] || this.color;
                          },
                        },
                      ]),
                      e
                ...
                var r = n(e("babel-runtime/helpers/classCallCheck")),
                  i = function e(t, n) {
                    ...
                    var i = "KaTeX parse error: " + t,
                      a = void 0,
                      o = void 0;
                    if (n && n.lexer && n.start <= n.end) {
                      var s = n.lexer.input;
                      ((a = n.start), (o = n.end), a === s.length ? (i += " at end of input: ") : (i += " at position " + (a + 1) + ": "));
                      var l = s.slice(a, o).replace(/[^]/g, "$&\u0332");
                      i +=
                    ...
                    var u = new Error(i);
                    return ((u.name = "ParseError"), (u.__proto__ = e.prototype), (u.position = a), u);
                  };
                ...
                var i = r(e("babel-runtime/helpers/classCallCheck")),
                  a = function e(t, n, r, a, o) {
                    ((0, i.default)(this, e),
                      ...
                      (this.value = n),
                      (this.mode = r),
                      !a || (o && o.lexer !== a.lexer) || ((this.lexer = a.lexer), (this.start = a.start), (this.end = (o || a).end)));
                  };
                n.default = a;
              },
              { "babel-runtime/helpers/classCallCheck": 4 },
            ...
            31: [
              function (e, t) {
                  ...
                  m = (function () {
                    function e(t, n) {
                      ((0, i.default)(this, e),
                        ...
                        n.colorIsTextColor && (this.gullet.macros["\\color"] = "\\textcolor"),
                        (this.settings = n),
                      ...
                      (0, a.default)(e, [
                        {
                          ...
                          value: function (e, t) {
                            if (this.nextToken.text !== e)
                              throw new f.default("Expected '" + e + "', got '" + this.nextToken.text + "'", this.nextToken);
                            !1 !== t && this.consume();
                          },
                        },
                        {
                        ...
                        },
                        {
                          ...
                          value: function (t, n) {
                            for (var r = []; ; ) {
                              ...
                              if (n && i.text === n) break;
                              if (t && o.default[i.text] && o.default[i.text].infix) break;
                        ...
                        },
                        {
                          ...
                          value: function (e) {
                            for (var t = -1, n = void 0, r = 0; r < e.length; r++) {
                              var i = e[r];
                              if ("infix" === i.type) {
                                if (-1 !== t) throw new f.default("only one infix operator per group", i.value.token);
                            ...
                            if (-1 !== t) {
                              var a = void 0,
                                ...
                                s = e.slice(0, t),
                                l = e.slice(t + 1);
                              ((a = 1 === s.length && "ordgroup" === s[0].type ? s[0] : new p.default("ordgroup", s, this.mode)),
                                (o = 1 === l.length && "ordgroup" === l[0].type ? l[0] : new p.default("ordgroup", l, this.mode)));
                        ...
                        },
                        {
                          ...
                          value: function (t) {
                            ...
                            if (i) {
                              if (i.isFunction) {
                                if (o.default[i.result].greediness > e.SUPSUB_GREEDINESS) return this.parseFunction(i);
                                throw new f.default("Got function '" + i.result + "' with no arguments as " + t, n);
                              }
                              return i.result;
                            }
                            if (this.settings.throwOnError || "\\" !== this.nextToken.text[0])
                              throw new f.default("Expected group after '" + r + "'", n);
                        ...
                        },
                        {
                          ...
                          value: function () {
                            for (var e = this.nextToken.text, t = [], n = 0; n < e.length; n++) t.push(new p.default("textord", e[n], "text"));
                            var r = new p.default("text", { body: t, type: "text" }, this.mode),
                              i = new p.default("color", { color: this.settings.errorColor, value: [r], type: "color" }, this.mode);
                        ...
                        },
                        {
                          ...
                          value: function () {
                            ...
                            for (var t = void 0, n = void 0; ; ) {
                              ...
                              if ("\\limits" === r.text || "\\nolimits" === r.text) {
                                if (!e || "op" !== e.type) throw new f.default("Limit controls must follow a math operator", r);
                                var i = "\\limits" === r.text;
                                ((e.value.limits = i), (e.value.alwaysHandleSupSub = !0), this.consume());
                              } else if ("^" === r.text) {
                                if (t) throw new f.default("Double superscript", r);
                                t = this.handleSupSubscript("superscript");
                              } else if ("_" === r.text) {
                                if (n) throw new f.default("Double subscript", r);
                                n = this.handleSupSubscript("subscript");
                              } else {
                                if ("'" !== r.text) break;
                                if (t) throw new f.default("Double superscript", r);
                                var a = new p.default("textord", "\\prime", this.mode),
                                  o = [a];
                                for (this.consume(); "'" === this.nextToken.text; ) (o.push(a), this.consume());
                                ("^" === this.nextToken.text && o.push(this.handleSupSubscript("superscript")),
                                  (t = new p.default("ordgroup", o, this.mode)));
                              }
                            }
                            return t || n ? new p.default("supsub", { base: e, sup: t, sub: n }, this.mode) : e;
                          },
                        },
                        {
                          ...
                          value: function () {
                            ...
                            if ("\\left" === n) {
                              ...
                              return new p.default("leftright", { body: i, left: r.value.value, right: a.value.value }, this.mode);
                            }
                            if ("\\begin" === n) {
                              var o = this.parseFunction(t),
                                l = o.value.name;
                              if (!s.default.hasOwnProperty(l)) throw new f.default("No such environment: " + l, o.value.nameGroup);
                              var u = s.default[l],
                                d = this.parseArguments("\\begin{" + l + "}", u),
                                h = { mode: this.mode, envName: l, parser: this, positions: d.pop() },
                                m = u.handler(h, d);
                              this.expect("\\end", !1);
                              var g = this.nextToken,
                                v = this.parseFunction();
                              if (v.value.name !== l) throw new f.default("Mismatch: \\begin{" + l + "} matched by \\end{" + v.value.name + "}", g);
                              return ((m.position = v.position), m);
                            }
                            if (c.default.contains(e.sizeFuncs, n)) {
                              this.consumeSpaces();
                              var b = this.parseExpression(!1);
                              return new p.default("sizing", { size: c.default.indexOf(e.sizeFuncs, n) + 1, value: b }, this.mode);
                            }
                            if (c.default.contains(e.styleFuncs, n)) {
                              this.consumeSpaces();
                              var y = this.parseExpression(!0);
                              return new p.default("styling", { style: n.slice(1, n.length - 5), value: y }, this.mode);
                            }
                            if (n in e.oldFontFuncs) {
                              ...
                              return "text" === x.slice(0, 4)
                                ? new p.default("text", { style: x, body: new p.default("ordgroup", w, this.mode) }, this.mode)
                                : new p.default("font", { font: x, body: new p.default("ordgroup", w, this.mode) }, this.mode);
                            }
                            if ("\\color" === n) {
                              var k = this.parseColorGroup(!1);
                              if (!k) throw new f.default("\\color not followed by color");
                              var M = this.parseExpression(!0);
                              return new p.default("color", { type: "color", color: k.result.value, value: M }, this.mode);
                            }
                            if ("$" === n) {
                              if ("math" === this.mode) throw new f.default("$ within math mode");
                              this.consume();
                              var S = this.mode;
                              this.switchMode("math");
                              var z = this.parseExpression(!1, "$");
                              return (this.expect("$", !0), this.switchMode(S), new p.default("styling", { style: "text", value: z }, "math"));
                            }
                            ...
                            if ((e || (e = this.parseGroup()), e)) {
                              if (e.isFunction) {
                                ...
                                if ("text" === this.mode && !n.allowedInText)
                                  throw new f.default("Can't use function '" + t + "' in text mode", e.token);
                                if ("math" === this.mode && !1 === n.allowedInMath)
                                  throw new f.default("Can't use function '" + t + "' in math mode", e.token);
                        ...
                        },
                        {
                          ...
                          value: function (e, t, n, r) {
                            var i = { funcName: e, parser: this, positions: n, token: r };
                        ...
                        },
                        {
                          ...
                          value: function (e, t) {
                            ...
                            for (var i = t.greediness, a = [this.pos], s = [], l = 0; l < n; l++) {
                              var u = this.nextToken,
                                c = t.argTypes && t.argTypes[l],
                                d = void 0;
                              if (l < t.numOptionalArgs) {
                                if (!(d = c ? this.parseGroupOfType(c, !0) : this.parseGroup(!0))) {
                                  (s.push(null), a.push(this.pos));
                                  continue;
                                }
                              } else if (!(d = c ? this.parseGroupOfType(c) : this.parseGroup())) {
                                if (this.settings.throwOnError || "\\" !== this.nextToken.text[0])
                                  throw new f.default("Expected group after '" + e + "'", u);
                                d = new r(this.handleUnsupportedCmd(this.nextToken.text), !1);
                              }
                              var h = void 0;
                              if (d.isFunction) {
                                if (!(o.default[d.result].greediness > i))
                                  throw new f.default("Got function '" + d.result + "' as argument to '" + e + "'", u);
                                h = this.parseFunction(d);
                              } else h = d.result;
                        ...
                        },
                        {
                          ...
                          value: function (e, t) {
                            var n = this.mode;
                            if (("original" === e && (e = n), "color" === e)) return this.parseColorGroup(t);
                            if ("size" === e) return this.parseSizeGroup(t);
                            (this.switchMode(e), "text" === e && this.consumeSpaces());
                        ...
                        },
                        {
                          ...
                          value: function (e, t) {
                            ...
                            for (var r = "", i = this.nextToken, a = i; this.nextToken.text !== (t ? "]" : "}"); ) {
                              if ("EOF" === this.nextToken.text) throw new f.default("Unexpected end of input in " + e, i.range(this.nextToken, r));
                              ((r += (a = this.nextToken).text), this.consume());
                            }
                            return ((this.mode = n), this.expect(t ? "]" : "}"), i.range(a, r));
                          },
                        },
                        {
                          key: "parseRegexGroup",
                          value: function (e, t) {
                            var n = this.mode;
                            this.mode = "text";
                            for (var r = this.nextToken, i = r, a = ""; "EOF" !== this.nextToken.text && e.test(a + this.nextToken.text); )
                              ((a += (i = this.nextToken).text), this.consume());
                            if ("" === a) throw new f.default("Invalid " + t + ": '" + r.text + "'", r);
                        ...
                        },
                        {
                          ...
                          value: function (e) {
                            ...
                            if (!n) throw new f.default("Invalid color: '" + t.text + "'", t);
                            return new r(new p.default("color", n[0], this.mode), !1);
                          },
                        },
                        {
                          key: "parseSizeGroup",
                          value: function (e) {
                            ...
                            if (!n) throw new f.default("Invalid size: '" + t.text + "'", t);
                            var i = { number: +(n[1] + n[2]), unit: n[3] };
                            if (!d.default.validUnit(i)) throw new f.default("Invalid unit: '" + i.unit + "'", t);
                            return new r(new p.default("size", i, this.mode), !1);
                          },
                        },
                        {
                          key: "parseGroup",
                          value: function (e) {
                            ...
                            if (this.nextToken.text === (e ? "[" : "{")) {
                              this.consume();
                              var n = this.parseExpression(!1, e ? "]" : null),
                                i = this.nextToken;
                              return (
                                this.expect(e ? "]" : "}"),
                                "text" === this.mode && this.formLigatures(n),
                                new r(new p.default("ordgroup", n, this.mode, t, i), !1)
                              );
                            }
                          ...
                          value: function (e) {
                            for (var t = e.length - 1, n = 0; n < t; ++n) {
                              ...
                              ("-" === i &&
                                "-" === e[n + 1].value &&
                                (n + 1 < t && "-" === e[n + 2].value
                                  ? (e.splice(n, 3, new p.default("textord", "---", "text", r, e[n + 2])), (t -= 2))
                                  : (e.splice(n, 2, new p.default("textord", "--", "text", r, e[n + 1])), (t -= 1))),
                                ("'" !== i && "`" !== i) ||
                                  e[n + 1].value !== i ||
                                  (e.splice(n, 2, new p.default("textord", i + i, "text", r, e[n + 1])), (t -= 1)));
                            }
                          },
                        },
                        {
                          ...
                          value: function () {
                            ...
                            return o.default[e.text]
                              ...
                              : u.default[this.mode][e.text]
                                ? (this.consume(), new r(new p.default(u.default[this.mode][e.text].group, e.text, this.mode, e), !1, e))
                                : "text" === this.mode && h.cjkRegex.test(e.text)
                                  ? (this.consume(), new r(new p.default("textord", e.text, this.mode, e), !1, e))
                                  : "$" === e.text
                                    ? new r(e.text, !1, e)
                                    : null;
                          },
                ...
                ((m.endOfExpression = ["}", "\\end", "\\right", "&", "\\\\", "\\cr"]),
                  ...
                  (m.styleFuncs = ["\\displaystyle", "\\textstyle", "\\scriptstyle", "\\scriptscriptstyle"]),
                  (m.oldFontFuncs = { "\\rm": "mathrm", "\\sf": "mathsf", "\\tt": "mathtt", "\\bf": "mathbf", "\\it": "mathit" }),
              ...
              function (e, t) {
                ...
                var r = n(e("babel-runtime/helpers/classCallCheck")),
                  ...
                  a = function e(t) {
                    ((0, r.default)(this, e),
                      (t = t || {}),
                      (this.displayMode = i.default.deflt(t.displayMode, !1)),
                      (this.throwOnError = i.default.deflt(t.throwOnError, !0)),
                      (this.errorColor = i.default.deflt(t.errorColor, "#cc0000")),
                      (this.macros = t.macros || {}),
                      (this.colorIsTextColor = i.default.deflt(t.colorIsTextColor, !1)));
                  };
                t.exports = a;
              },
            ...
            33: [
              function (e, t) {
                ...
                var r = n(e("babel-runtime/helpers/classCallCheck")),
                  ...
                  a = (function () {
                    function e(t, n, i) {
                      ((0, r.default)(this, e), (this.id = t), (this.size = n), (this.cramped = i));
                    }
                    return (
                      (0, i.default)(e, [
                        {
                  ...
                  y = [s, s, u, u, d, d, p, p],
                  x = [o, s, l, u, l, u, l, u];
                t.exports = { DISPLAY: f[o], TEXT: f[l], SCRIPT: f[c], SCRIPTSCRIPT: f[h] };
              },
            ...
            34: [
              function (e, t) {
                ...
                var r = n(e("./domTree")),
                  ...
                  l = function (e, t, n) {
                    return (
                      a.default[n][e] && a.default[n][e].replace && (e = a.default[n][e].replace),
                      { value: e, metrics: i.default.getCharacterMetrics(e, t) }
                    );
                  },
                  u = function (e, t, n, i, a) {
                    ...
                    if (s) {
                      var c = s.italic;
                      ("text" === n && (c = 0), (u = new r.default.symbolNode(e, s.height, s.depth, c, s.skew, a)));
                    } else u = new r.default.symbolNode(e, 0, 0, 0, 0, a);
                    return (
                      i &&
                  ...
                  d = function (e, t, n, r, i) {
                    ...
                    if ("textord" === i)
                      return "ams" === (a.default[t][e] && a.default[t][e].font)
                        ? u(e, "AMS-Regular", t, n, r.concat(["amsrm"]))
                        : u(e, "Main-Regular", t, n, r.concat(["mathrm"]));
                    throw new Error("unexpected type: " + i + " in mathDefault");
                  },
                  h = function (e) {
                    return /[0-9]/.test(e.charAt(0)) || o.default.contains(s, e)
                  ...
                  p = function (e, t, n) {
                    ...
                    if (c) {
                      var p = void 0;
                      return (
                        (p = "mathit" === c || o.default.contains(s, i) ? h(i) : x[c]),
                        l(i, p.fontName, r).metrics ? u(i, p.fontName, r, t, a.concat([p.fontClass || c])) : d(i, r, t, a, n)
                      );
                    }
                    return d(i, r, t, a, n);
                  },
                  f = function (e) {
                    ...
                    if (e.children)
                      for (var i = 0; i < e.children.length; i++)
                        (e.children[i].height > t && (t = e.children[i].height),
                          e.children[i].depth > n && (n = e.children[i].depth),
                          e.children[i].maxFontSize > r && (r = e.children[i].maxFontSize));
                  ...
                  b = function (e, t, n) {
                    ...
                    if ("individualShift" === t) {
                      var s = e;
                      for (e = [s[0]], a = i = -s[0].shift - s[0].elem.depth, o = 1; o < s.length; o++) {
                        var l = -s[o].shift - a - s[o].elem.depth,
                          u = l - (s[o - 1].elem.height + s[o - 1].elem.depth);
                        ((a += l), e.push({ type: "kern", size: u }), e.push(s[o]));
                      }
                    } else if ("top" === t) {
                      var c = n;
                      for (o = 0; o < e.length; o++) "kern" === e[o].type ? (c -= e[o].size) : (c -= e[o].elem.height + e[o].elem.depth);
                      i = c;
                    ...
                    for (o = 0; o < e.length; o++)
                      if ("elem" === e[o].type) {
                        var h = e[o].elem;
                        d = Math.max(d, h.maxFontSize, h.height);
                      }
                    d += 2;
                    var p = m(["pstrut"], []);
                    p.style.height = d + "em";
                    ...
                    for (a = i, o = 0; o < e.length; o++) {
                      if ("kern" === e[o].type) a += e[o].size;
                        ...
                        var b = e[o].elem,
                          y = m([], [p, b]);
                        ((y.style.top = -d - a - b.depth + "em"),
                          e[o].marginLeft && (y.style.marginLeft = e[o].marginLeft),
                          e[o].marginRight && (y.style.marginRight = e[o].marginRight),
                          f.push(y),
                          (a += b.height + b.depth));
                      }
                    ...
                    if (g < 0) {
                      var k = m(["vlist"], []);
                      k.style.height = -g + "em";
                      var M = m(["vlist-s"], [new r.default.symbolNode("\u200b")]);
                      w = [m(["vlist-r"], [x, M]), m(["vlist-r"], [k])];
                    } else w = [m(["vlist-r"], [x])];
                    var S = m(["vlist-t"], w);
                    return (2 === w.length && S.classes.push("vlist-t2"), (S.height = v), (S.depth = -g), S);
                  },
                  y = {
            ...
            35: [
              function (e, t) {
                ...
                function r(e, t, n) {
                  for (var r = y(e, t, !1), i = t.sizeMultiplier / n.sizeMultiplier, a = 0; a < r.length; a++) {
                    var o = h.default.indexOf(r[a].classes, "sizing");
                    (o < 0
                      ? Array.prototype.push.apply(r[a].classes, t.sizingClasses(n))
                      : r[a].classes[o + 1] === "reset-size" + t.size && (r[a].classes[o + 1] = "reset-size" + n.size),
                      (r[a].height *= i),
                      (r[a].depth *= i));
                  }
                ...
                var i = n(e("babel-runtime/core-js/json/stringify")),
                  ...
                  p = n(e("./stretchy")),
                  f = function (e) {
                    return e instanceof c.default.span && "mspace" === e.classes[0];
                  },
                  m = function (e) {
                    return e && "mbin" === e.classes[0];
                  },
                  g = function (e, t) {
                    return e ? h.default.contains(["mbin", "mopen", "mrel", "mop", "mpunct"], e.classes[0]) : t;
                  },
                  v = function (e, t) {
                    return e ? h.default.contains(["mrel", "mclose", "mpunct"], e.classes[0]) : t;
                  },
                  b = function (e, t) {
                  ...
                  y = function (e, t, n) {
                    for (var r = [], i = 0; i < e.length; i++) {
                      var a = e[i],
                        o = C(a, t);
                      o instanceof c.default.documentFragment ? Array.prototype.push.apply(r, o.children) : r.push(o);
                    }
                    for (var u = 0; u < r.length; u++) {
                      ...
                      if (d) {
                        ...
                        (r[u] instanceof c.default.symbolNode && (r[u] = (0, s.makeSpan)([].concat(r[u].classes), [r[u]])),
                          l.default.prependChildren(r[u], d));
                      }
                    }
                    for (var h = 0; h < r.length; h++) m(r[h]) && (g(r[h - 1], n) || v(r[h + 1], n)) && (r[h].classes[0] = "mord");
                    for (var p = 0; p < r.length; p++)
                      if ("\u0338" === r[p].value && p + 1 < r.length) {
                        var f = r.slice(p, p + 2);
                        ((f[0].classes = ["mainrm"]), (f[0].style.position = "absolute"), (f[0].style.right = "0"));
                        var y = r[p + 1].classes,
                          x = (0, s.makeSpan)(y, f);
                        (-1 !== y.indexOf("mord") && (x.style.paddingLeft = "0.277771em"), (x.style.position = "relative"), r.splice(p, 2, x));
                      }
                    return r;
                  },
                  x = function e(t) {
                    if (t instanceof c.default.documentFragment) {
                      if (t.children.length) return e(t.children[t.children.length - 1]);
                    } else if (h.default.contains(["mord", "mop", "mbin", "mrel", "mopen", "mclose", "mpunct", "minner"], t.classes[0]))
                      return t.classes[0];
                    return null;
                  },
                  w = function (e, t) {
                    if (e.value.base) {
                      var n = e.value.base;
                      return "op" === n.type
                        ? n.value.limits && (t.style.size === o.default.DISPLAY.size || n.value.alwaysHandleSupSub)
                        : "accent" === n.type
                          ? M(n.value.base)
                          : "horizBrace" === n.type
                  ...
                  z = {
                    ...
                    bin: function (e, t) {
                      return l.default.mathsym(e.value, e.mode, t, ["mbin"]);
                    },
                    rel: function (e, t) {
                      return l.default.mathsym(e.value, e.mode, t, ["mrel"]);
                    },
                    open: function (e, t) {
                      return l.default.mathsym(e.value, e.mode, t, ["mopen"]);
                    },
                    close: function (e, t) {
                      return l.default.mathsym(e.value, e.mode, t, ["mclose"]);
                    },
                    inner: function (e, t) {
                      return l.default.mathsym(e.value, e.mode, t, ["minner"]);
                    },
                    punct: function (e, t) {
                      return l.default.mathsym(e.value, e.mode, t, ["mpunct"]);
                    },
                    ordgroup: function (e, t) {
                      return (0, s.makeSpan)(["mord"], y(e.value, t, !0), t);
                    },
                    text: function (e, t) {
                      for (var n = t.withFont(e.value.style), r = y(e.value.body, n, !0), i = 0; i < r.length - 1; i++)
                        r[i].tryCombine(r[i + 1]) && (r.splice(i + 1, 1), i--);
                      return (0, s.makeSpan)(["mord", "text"], r, n);
                    },
                    color: function (e, t) {
                      var n = y(e.value.value, t.withColor(e.value.color), !1);
                    ...
                    supsub: function (e, t) {
                      ...
                      (e.value.sup &&
                        ...
                        (r = C(e.value.sup, u, t)),
                        M(e.value.base) || (d = n.height - (u.fontMetrics().supDrop * u.sizeMultiplier) / t.sizeMultiplier)),
                        e.value.sub &&
                          ((u = t.havingStyle(t.style.sub())),
                          (i = C(e.value.sub, u, t)),
                          M(e.value.base) || (h = n.depth + (u.fontMetrics().subDrop * u.sizeMultiplier) / t.sizeMultiplier)));
                      var p = void 0;
                      p = t.style === o.default.DISPLAY ? a.sup1 : t.style.cramped ? a.sup3 : a.sup2;
                      var f = t.sizeMultiplier,
                        m = 0.5 / a.ptPerEm / f + "em",
                        g = void 0;
                      if (e.value.sup)
                        if (e.value.sub) {
                          ((d = Math.max(d, p, r.depth + 0.25 * a.xHeight)), (h = Math.max(h, a.sub2)));
                          var v = a.defaultRuleThickness;
                          if (d - r.depth - (i.height - h) < 4 * v) {
                            h = 4 * v - (d - r.depth) + i.height;
                            var b = 0.8 * a.xHeight - (d - r.depth);
                            b > 0 && ((d += b), (h -= b));
                          }
                          var y = [
                            { type: "elem", elem: i, shift: h, marginRight: m },
                            { type: "elem", elem: r, shift: -d, marginRight: m },
                          ];
                          (n instanceof c.default.symbolNode && (y[0].marginLeft = -n.italic + "em"),
                            (g = l.default.makeVList(y, "individualShift", null, t)));
                        } else
                          ((d = Math.max(d, p, r.depth + 0.25 * a.xHeight)),
                            (g = l.default.makeVList([{ type: "elem", elem: r, marginRight: m }], "shift", -d, t)));
                      else {
                        h = Math.max(h, a.sub1, i.height - 0.8 * a.xHeight);
                        var k = [{ type: "elem", elem: i, marginRight: m }];
                        (n instanceof c.default.symbolNode && (k[0].marginLeft = -n.italic + "em"), (g = l.default.makeVList(k, "shift", h, t)));
                      }
                      var S = x(n) || "mord";
                      return (0, s.makeSpan)([S], [n, (0, s.makeSpan)(["msupsub"], [g])], t);
                    },
                    genfrac: function (e, t) {
                      var n = t.style;
                      "display" === e.value.size ? (n = o.default.DISPLAY) : "text" === e.value.size && (n = o.default.TEXT);
                      var r = n.fracNum(),
                        i = n.fracDen(),
                        a = void 0;
                      a = t.havingStyle(r);
                      var c = C(e.value.numer, a, t);
                      a = t.havingStyle(i);
                      var d = C(e.value.denom, a, t),
                        h = void 0,
                        p = void 0,
                        f = void 0;
                      e.value.hasBarLine
                        ? ((p = (h = A("frac-line", t)).height), (f = h.height))
                        : ((h = null), (p = 0), (f = t.fontMetrics().defaultRuleThickness));
                      var m = void 0,
                        g = void 0,
                        v = void 0;
                      n.size === o.default.DISPLAY.size
                        ? ((m = t.fontMetrics().num1), (g = p > 0 ? 3 * f : 7 * f), (v = t.fontMetrics().denom1))
                        : (p > 0 ? ((m = t.fontMetrics().num2), (g = f)) : ((m = t.fontMetrics().num3), (g = 3 * f)), (v = t.fontMetrics().denom2));
                      var b = void 0;
                      if (0 === p) {
                        var y = m - c.depth - (d.height - v);
                        (y < g && ((m += 0.5 * (g - y)), (v += 0.5 * (g - y))),
                          (b = l.default.makeVList(
                            [
                              { type: "elem", elem: d, shift: v },
                              { type: "elem", elem: c, shift: -m },
                            ],
                            "individualShift",
                            null,
                            t
                        ...
                        (m - c.depth - (x + 0.5 * p) < g && (m += g - (m - c.depth - (x + 0.5 * p))),
                          x - 0.5 * p - (d.height - v) < g && (v += g - (x - 0.5 * p - (d.height - v))));
                        var w = -(x - 0.5 * p);
                        b = l.default.makeVList(
                          [
                            { type: "elem", elem: d, shift: v },
                      ...
                      var k = void 0;
                      k = n.size === o.default.DISPLAY.size ? t.fontMetrics().delim1 : t.fontMetrics().delim2;
                      var M = void 0,
                        z = void 0;
                      return (
                        (M =
                          null == e.value.leftDelim
                            ? S(t, ["mopen"])
                            : u.default.customSizedDelim(e.value.leftDelim, k, !0, t.havingStyle(n), e.mode, ["mopen"])),
                        (z =
                          null == e.value.rightDelim
                            ? S(t, ["mclose"])
                            : u.default.customSizedDelim(e.value.rightDelim, k, !0, t.havingStyle(n), e.mode, ["mclose"])),
                        (0, s.makeSpan)(["mord"].concat(a.sizingClasses(t)), [M, (0, s.makeSpan)(["mfrac"], [b]), z], t)
                      );
                    },
                    array: function (e, t) {
                      var n = void 0,
                      ...
                      for (n = 0; n < e.value.body.length; ++n) {
                        ...
                        for (r = 0; r < x.length; ++r) {
                          var S = C(x[r], t);
                          (k < S.depth && (k = S.depth), w < S.height && (w = S.height), (M[r] = S));
                        }
                        var z = 0;
                        (e.value.rowGaps[n] && (z = d.default.calculateSize(e.value.rowGaps[n].value, t)) > 0 && (k < (z += b) && (k = z), (z = 0)),
                          e.value.addJot && (k += m),
                          (M.height = w),
                          (M.depth = k),
                          (y += w),
                      ...
                      for (r = 0, R = 0; r < o || R < T.length; ++r, ++R) {
                        for (var L = T[R] || {}, O = !0; "separator" === L.type; ) {
                          if (
                            (O || (((E = (0, s.makeSpan)(["arraycolsep"], [])).style.width = t.fontMetrics().doubleRuleSep + "em"), N.push(E)),
                            "|" !== L.separator)
                          )
                            throw new a.default("Invalid separator type: " + L.separator);
                          var q = (0, s.makeSpan)(["vertical-separator"], []);
                          ((q.style.height = y + "em"), (q.style.verticalAlign = -(y - A) + "em"), N.push(q), (L = T[++R] || {}), (O = !1));
                        }
                        if (!(r >= o)) {
                          var _ = void 0;
                          (r > 0 || e.value.hskipBeforeAndAfter) &&
                            0 !== (_ = h.default.deflt(L.pregap, p)) &&
                            (((E = (0, s.makeSpan)(["arraycolsep"], [])).style.width = _ + "em"), N.push(E));
                          var D = [];
                          for (n = 0; n < i; ++n) {
                            var B = u[n],
                              I = B[r];
                            if (I) {
                              var H = B.pos - A;
                              ((I.depth = B.depth), (I.height = B.height), D.push({ type: "elem", elem: I, shift: H }));
                            }
                          }
                          ((D = l.default.makeVList(D, "individualShift", null, t)),
                            (D = (0, s.makeSpan)(["col-align-" + (L.align || "c")], [D])),
                            N.push(D),
                      ...
                      return ((u = (0, s.makeSpan)(["mtable"], N)), (0, s.makeSpan)(["mord"], [u], t));
                    },
                    spacing: function (e, t) {
                      return "\\ " === e.value || "\\space" === e.value || " " === e.value || "~" === e.value
                        ? "text" === e.mode
                          ? l.default.makeOrd(e, t, "textord")
                          : (0, s.makeSpan)(["mspace"], [l.default.mathsym(e.value, e.mode, t)], t)
                        : (0, s.makeSpan)(["mspace", l.default.spacingFunctions[e.value].className], [], t);
                    },
                    llap: function (e, t) {
                      var n = (0, s.makeSpan)(["inner"], [C(e.value.body, t)]),
                        r = (0, s.makeSpan)(["fix"], []);
                    ...
                    op: function (e, t) {
                      var n = void 0,
                        r = void 0,
                        i = !1;
                      "supsub" === e.type && ((n = e.value.sup), (r = e.value.sub), (e = e.value.base), (i = !0));
                      var a = t.style,
                        u = ["\\smallint"],
                        d = !1;
                      a.size === o.default.DISPLAY.size && e.value.symbol && !h.default.contains(u, e.value.body) && (d = !0);
                      var p = void 0;
                      if (e.value.symbol) {
                        var f = d ? "Size2-Regular" : "Size1-Regular";
                        p = l.default.makeSymbol(e.value.body, f, "math", t, ["mop", "op-symbol", d ? "large-op" : "small-op"]);
                      } else if (e.value.value) {
                        var m = y(e.value.value, t, !0);
                        1 === m.length && m[0] instanceof c.default.symbolNode
                          ? ((p = m[0]).classes[0] = "mop")
                          : (p = (0, s.makeSpan)(["mop"], m, t));
                      } else {
                        for (var g = [], v = 1; v < e.value.body.length; v++) g.push(l.default.mathsym(e.value.body[v], e.mode));
                        p = (0, s.makeSpan)(["mop"], g, t);
                      }
                      var b = 0,
                        x = 0;
                      if ((p instanceof c.default.symbolNode && ((b = (p.height - p.depth) / 2 - t.fontMetrics().axisHeight), (x = p.italic)), i)) {
                        p = (0, s.makeSpan)([], [p]);
                        var w = void 0,
                          k = void 0,
                          M = void 0,
                        ...
                        (n &&
                          ...
                          (w = C(n, z, t)),
                          (k = Math.max(t.fontMetrics().bigOpSpacing1, t.fontMetrics().bigOpSpacing3 - w.depth))),
                          r &&
                            ((z = t.havingStyle(a.sub())),
                            (M = C(r, z, t)),
                            (S = Math.max(t.fontMetrics().bigOpSpacing2, t.fontMetrics().bigOpSpacing4 - M.height))));
                        var A = void 0,
                          T = void 0,
                          N = void 0;
                        if (n)
                          if (r) {
                            if (!n && !r) return p;
                            ((N = t.fontMetrics().bigOpSpacing5 + M.height + M.depth + S + p.depth + b),
                              (A = l.default.makeVList(
                                [
                                  { type: "kern", size: t.fontMetrics().bigOpSpacing5 },
                                  { type: "elem", elem: M, marginLeft: -x + "em" },
                                  { type: "kern", size: S },
                                  { type: "elem", elem: p },
                                  { type: "kern", size: k },
                      ...
                      return (b && ((p.style.position = "relative"), (p.style.top = b + "em")), p);
                    },
                    mod: function (e, t) {
                      var n = [];
                      if (
                        ("bmod" === e.value.modType
                          ? (t.style.isTight() || n.push((0, s.makeSpan)(["mspace", "negativemediumspace"], [], t)),
                            n.push((0, s.makeSpan)(["mspace", "thickspace"], [], t)))
                          : t.style.size === o.default.DISPLAY.size
                            ? n.push((0, s.makeSpan)(["mspace", "quad"], [], t))
                            : "mod" === e.value.modType
                              ? n.push((0, s.makeSpan)(["mspace", "twelvemuspace"], [], t))
                              : n.push((0, s.makeSpan)(["mspace", "eightmuspace"], [], t)),
                        ("pod" !== e.value.modType && "pmod" !== e.value.modType) || n.push(l.default.mathsym("(", e.mode)),
                        "pod" !== e.value.modType)
                      ) {
                        var r = [l.default.mathsym("m", e.mode), l.default.mathsym("o", e.mode), l.default.mathsym("d", e.mode)];
                        "bmod" === e.value.modType
                          ? (n.push((0, s.makeSpan)(["mbin"], r, t)),
                            n.push((0, s.makeSpan)(["mspace", "thickspace"], [], t)),
                            t.style.isTight() || n.push((0, s.makeSpan)(["mspace", "negativemediumspace"], [], t)))
                          : (Array.prototype.push.apply(n, r), n.push((0, s.makeSpan)(["mspace", "sixmuspace"], [], t)));
                      }
                      return (
                        e.value.value && Array.prototype.push.apply(n, y(e.value.value, t, !1)),
                        ("pod" !== e.value.modType && "pmod" !== e.value.modType) || n.push(l.default.mathsym(")", e.mode)),
                        l.default.makeFragment(n)
                      );
                    },
                    katex: function (e, t) {
                      var n = (0, s.makeSpan)(["k"], [l.default.mathsym("K", e.mode)], t),
                        r = (0, s.makeSpan)(["a"], [l.default.mathsym("A", e.mode)], t);
                      ((r.height = 0.75 * (r.height + 0.2)), (r.depth = 0.75 * (r.height - 0.2)));
                      var i = (0, s.makeSpan)(["t"], [l.default.mathsym("T", e.mode)], t),
                        a = (0, s.makeSpan)(["e"], [l.default.mathsym("E", e.mode)], t);
                      ((a.height = a.height - 0.2155), (a.depth = a.depth + 0.2155));
                      var o = (0, s.makeSpan)(["x"], [l.default.mathsym("X", e.mode)], t);
                      return (0, s.makeSpan)(["mord", "katex-logo"], [n, r, i, a, o], t);
                    },
                  },
                  A = function (e, t, n) {
                ...
                ((z.overline = function (e, t) {
                  ...
                  (z.sqrt = function (e, t) {
                    var n = C(e.value.body, t.havingCrampedStyle());
                    n instanceof c.default.documentFragment && (n = (0, s.makeSpan)([], [n], t));
                    var r = t.fontMetrics().defaultRuleThickness,
                      i = r;
                    t.style.id < o.default.TEXT.id && (i = t.fontMetrics().xHeight);
                    var a = r + i / 4,
                      d = (n.height + n.depth + a + r) * t.sizeMultiplier,
                      h = u.default.customSizedDelim("\\surd", d, !1, t, e.mode),
                      p = t.fontMetrics().sqrtRuleThickness * h.sizeMultiplier,
                      f = h.height - p;
                    ...
                    if (
                      ...
                      var v = t.havingStyle(o.default.SCRIPTSCRIPT),
                        ...
                        x = l.default.makeVList([{ type: "elem", elem: b }], "shift", -y, t),
                  ...
                  (z.styling = function (e, t) {
                    var n = { display: o.default.DISPLAY, text: o.default.TEXT, script: o.default.SCRIPT, scriptscript: o.default.SCRIPTSCRIPT }[
                        e.value.style
                      ],
                      i = t.havingStyle(n);
                  ...
                  (z.delimsizing = function (e, t) {
                    var n = e.value.value;
                    return "." === n ? (0, s.makeSpan)([e.value.mclass]) : u.default.sizedDelim(n, e.value.size, t, e.mode, [e.value.mclass]);
                  }),
                  (z.leftright = function (e, t) {
                    for (var n = y(e.value.body, t, !0), r = 0, i = 0, a = !1, o = 0; o < n.length; o++)
                      n[o].isMiddle ? (a = !0) : ((r = Math.max(n[o].height, r)), (i = Math.max(n[o].depth, i)));
                    ((r *= t.sizeMultiplier), (i *= t.sizeMultiplier));
                    var c = void 0;
                    if (
                      ((c = "." === e.value.left ? S(t, ["mopen"]) : u.default.leftRightDelim(e.value.left, r, i, t, e.mode, ["mopen"])),
                      n.unshift(c),
                      a)
                    )
                      for (var d = 1; d < n.length; d++) {
                        var h = n[d];
                        if (h.isMiddle) {
                          n[d] = u.default.leftRightDelim(h.isMiddle.value, r, i, h.isMiddle.options, e.mode, []);
                          var p = b(h.children, 0);
                          p && l.default.prependChildren(n[d], p);
                        }
                      }
                    var f = void 0;
                    return (
                      (f = "." === e.value.right ? S(t, ["mclose"]) : u.default.leftRightDelim(e.value.right, r, i, t, e.mode, ["mclose"])),
                      n.push(f),
                  ...
                  (z.middle = function (e, t) {
                    ...
                    return (
                      "." === e.value.value
                        ? (n = S(t, []))
                        : ((n = u.default.sizedDelim(e.value.value, 1, t, e.mode, [])).isMiddle = { value: e.value.value, options: t }),
                      n
                    );
                  }),
                  (z.rule = function (e, t) {
                    var n = (0, s.makeSpan)(["mord", "rule"], [], t),
                      r = 0;
                    e.value.shift && (r = d.default.calculateSize(e.value.shift, t));
                    var i = d.default.calculateSize(e.value.width, t),
                      a = d.default.calculateSize(e.value.height, t);
                    return (
                  ...
                  (z.kern = function (e, t) {
                    ...
                    if (e.value.dimension) {
                      var r = d.default.calculateSize(e.value.dimension, t);
                  ...
                  (z.accent = function (e, t) {
                    ...
                    if ("supsub" === e.type) {
                      var i = e;
                      ((n = (e = i.value.base).value.base), (i.value.base = n), (r = C(i, t)));
                    }
                    ...
                    if (e.value.isStretchy) {
                      ...
                      (h.classes.push("svg-align"), o > 0 && ((h.style.width = "calc(100% - " + 2 * o + "em)"), (h.style.marginLeft = 2 * o + "em")));
                    } else {
                      var f = l.default.makeSymbol(e.value.label, "Main-Regular", e.mode, t);
                      f.italic = 0;
                      var m = null;
                      ("\\vec" === e.value.label ? (m = "accent-vec") : "\\H" === e.value.label && (m = "accent-hungarian"),
                        (d = (0, s.makeSpan)([], [f])),
                        ((d = (0, s.makeSpan)(["accent-body", m], [d])).style.marginLeft = 2 * o + "em"),
                    ...
                    var g = (0, s.makeSpan)(["mord", "accent"], [d], t);
                  ...
                  (z.horizBrace = function (e, t) {
                    ...
                    r &&
                      (e.value.sup
                        ? ((a = t.havingStyle(n.sup())), (i = C(e.value.sup, a, t)))
                        : ((a = t.havingStyle(n.sub())), (i = C(e.value.sub, a, t))),
                      (e = e.value.base));
                    var u = C(e.value.base, t.havingBaseStyle(o.default.DISPLAY)),
                    ...
                    if (
                      (e.value.isOver
                        ...
                        : (d = l.default.makeVList(
                            ...
                            "bottom",
                            u.depth + 0.1 + c.height,
                            t
                          )).children[0].children[0].children[0].classes.push("svg-align"),
                      r)
                    ) {
                      var h = (0, s.makeSpan)(["mord", e.value.isOver ? "mover" : "munder"], [d], t);
                      d = e.value.isOver
                        ? l.default.makeVList(
                            [
                              { type: "elem", elem: h },
                    ...
                    return (0, s.makeSpan)(["mord", e.value.isOver ? "mover" : "munder"], [d], t);
                  }),
                  (z.accentUnder = function (e, t) {
                    ...
                    return (a.children[0].children[0].children[0].classes.push("svg-align"), (0, s.makeSpan)(["mord", "accentunder"], [a], t));
                  }),
                  (z.enclose = function (e, t) {
                    var n = C(e.value.body, t),
                      ...
                      u = 0;
                    if ("sout" === r)
                      (((a = (0, s.makeSpan)(["stretchy", "sout"])).height = t.fontMetrics().defaultRuleThickness / i),
                        (u = -0.5 * t.fontMetrics().xHeight));
                    else {
                      n.classes.push("fbox" === r ? "boxpad" : "cancel-pad");
                      var c = M(e.value.body);
                      ((o = "fbox" === r ? 0.34 : c ? 0.2 : 0), (u = n.depth + o), (a = p.default.encloseSpan(n, r, o, t)));
                    }
                    var d = l.default.makeVList(
                      [
                    ...
                    return (
                      "fbox" !== r && d.children[0].children[0].children[1].classes.push("svg-align"),
                      /cancel/.test(r) ? (0, s.makeSpan)(["mord", "cancel-lap"], [d], t) : (0, s.makeSpan)(["mord"], [d], t)
                    );
                  }),
                  (z.xArrow = function (e, t) {
                    ...
                    var a = void 0;
                    e.value.below && ((r = t.havingStyle(n.sub())), (a = C(e.value.below, r, t)).classes.push("x-arrow-pad"));
                    var o = p.default.svgSpan(e, t),
                      u = -t.fontMetrics().axisHeight + o.depth,
                      c = -t.fontMetrics().axisHeight - o.height - 0.111,
                      d = void 0;
                    if (e.value.below) {
                      var h = -t.fontMetrics().axisHeight + a.height + o.height + 0.111;
                      d = l.default.makeVList(
                        [
                    ...
                    return (d.children[0].children[0].children[1].classes.push("svg-align"), (0, s.makeSpan)(["mrel", "x-arrow"], [d], t));
                  }),
                ...
                var C = function (e, t, n) {
                    ...
                    throw new a.default("Got group of unknown type: '" + e.type + "'");
                  },
                  T = function (e, t) {
                    ...
                    ((a.style.height = r.height + "em"), (o.style.height = r.height + r.depth + "em"), (o.style.verticalAlign = -r.depth + "em"));
            ...
            36: [
              function (e, t) {
                ...
                var r = e("./buildCommon"),
                  ...
                  d = n(e("./stretchy")),
                  h = function (e, t) {
                    return (u.default[t][e] && u.default[t][e].replace && (e = u.default[t][e].replace), new o.default.TextNode(e));
                  },
                  p = function (e, t) {
                    var n = t.font;
                    if (!n) return null;
                    ...
                    var o = e.value;
                    if (c.default.contains(["\\imath", "\\jmath"], o)) return null;
                    u.default[i][o] && u.default[i][o].replace && (o = u.default[i][o].replace);
                    var s = r.fontMap[n].fontName;
                    return a.default.getCharacterMetrics(o, s) ? r.fontMap[t.font].variant : null;
                  },
                  f = {},
                  m = { mi: "italic", mn: "normal", mtext: "normal" };
                ((f.mathord = function (e, t) {
                  var n = new o.default.MathNode("mi", [h(e.value, e.mode)]),
                    r = p(e, t) || "italic";
                  return (r !== m[n.type] && n.setAttribute("mathvariant", r), n);
                }),
                  ...
                  (f.bin = function (e) {
                    return new o.default.MathNode("mo", [h(e.value, e.mode)]);
                  }),
                  (f.rel = function (e) {
                    return new o.default.MathNode("mo", [h(e.value, e.mode)]);
                  }),
                  ...
                  (f.punct = function (e) {
                    var t = new o.default.MathNode("mo", [h(e.value, e.mode)]);
                  ...
                  (f.text = function (e, t) {
                    for (var n = e.value.body, r = [], i = null, a = 0; a < n.length; a++) {
                      var s = v(n[a], t);
                      "mtext" === s.type && null != i
                        ? Array.prototype.push.apply(i.children, s.children)
                        : (r.push(s), "mtext" === s.type && (i = s));
                    }
                    return 1 === r.length ? r[0] : new o.default.MathNode("mrow", r);
                  }),
                  ...
                  (f.supsub = function (e, t) {
                    ...
                    (e.value.sub && a.push(v(e.value.sub, t, i)), e.value.sup && a.push(v(e.value.sup, t, i)));
                    var s = void 0;
                    if (n) s = r ? "mover" : "munder";
                    else if (e.value.sub)
                      if (e.value.sup) {
                        var u = e.value.base;
                        s = u && u.value.limits && t.style === l.default.DISPLAY ? "munderover" : "msubsup";
                      } else s = "msub";
                    else s = "msup";
                    return new o.default.MathNode(s, a);
                  }),
                  (f.genfrac = function (e, t) {
                    var n = new o.default.MathNode("mfrac", [v(e.value.numer, t), v(e.value.denom, t)]);
                    if ((e.value.hasBarLine || n.setAttribute("linethickness", "0px"), null != e.value.leftDelim || null != e.value.rightDelim)) {
                      var r = [];
                      if (null != e.value.leftDelim) {
                        var i = new o.default.MathNode("mo", [new o.default.TextNode(e.value.leftDelim)]);
                        (i.setAttribute("fence", "true"), r.push(i));
                      }
                      if ((r.push(n), null != e.value.rightDelim)) {
                        var a = new o.default.MathNode("mo", [new o.default.TextNode(e.value.rightDelim)]);
                    ...
                    return new o.default.MathNode(
                      ...
                      e.value.body.map(function (e) {
                        return new o.default.MathNode(
                          "mtr",
                          e.map(function (e) {
                            return new o.default.MathNode("mtd", [v(e, t)]);
                          })
                        );
                      })
                    );
                  ...
                  (f.sqrt = function (e, t) {
                    return e.value.index
                      ? new o.default.MathNode("mroot", [v(e.value.body, t), v(e.value.index, t)])
                      : new o.default.MathNode("msqrt", [v(e.value.body, t)]);
                  }),
                  (f.leftright = function (e, t) {
                    var n = g(e.value.body, t);
                    if ("." !== e.value.left) {
                      var r = new o.default.MathNode("mo", [h(e.value.left, e.mode)]);
                      (r.setAttribute("fence", "true"), n.unshift(r));
                    }
                    if ("." !== e.value.right) {
                      var i = new o.default.MathNode("mo", [h(e.value.right, e.mode)]);
                      (i.setAttribute("fence", "true"), n.push(i));
                    }
                    return new o.default.MathNode("mrow", n);
                  }),
                  (f.middle = function (e) {
                    var t = new o.default.MathNode("mo", [h(e.value.middle, e.mode)]);
                    return (t.setAttribute("fence", "true"), t);
                  }),
                  (f.accent = function (e, t) {
                    var n = void 0;
                    n = e.value.isStretchy ? d.default.mathMLnode(e.value.label) : new o.default.MathNode("mo", [h(e.value.label, e.mode)]);
                    var r = new o.default.MathNode("mover", [v(e.value.base, t), n]);
                    return (r.setAttribute("accent", "true"), r);
                  }),
                  (f.spacing = function (e) {
                    var t = void 0;
                    return (
                      "\\ " === e.value || "\\space" === e.value || " " === e.value || "~" === e.value
                        ? (t = new o.default.MathNode("mtext", [new o.default.TextNode("\xa0")]))
                        : (t = new o.default.MathNode("mspace")).setAttribute("width", i.default.spacingFunctions[e.value].size),
                      t
                    );
                  }),
                  (f.op = function (e, t) {
                    return e.value.symbol
                      ? new o.default.MathNode("mo", [h(e.value.body, e.mode)])
                      : e.value.value
                        ? new o.default.MathNode("mo", g(e.value.value, t))
                        : new o.default.MathNode("mi", [new o.default.TextNode(e.value.body.slice(1))]);
                  }),
                  (f.mod = function (e, t) {
                    var n = [];
                    if (
                      (("pod" !== e.value.modType && "pmod" !== e.value.modType) || n.push(new o.default.MathNode("mo", [h("(", e.mode)])),
                      "pod" !== e.value.modType && n.push(new o.default.MathNode("mo", [h("mod", e.mode)])),
                      e.value.value)
                    ) {
                      var r = new o.default.MathNode("mspace");
                      (r.setAttribute("width", "0.333333em"), n.push(r), (n = n.concat(g(e.value.value, t))));
                    }
                    return (
                      ("pod" !== e.value.modType && "pmod" !== e.value.modType) || n.push(new o.default.MathNode("mo", [h(")", e.mode)])),
                      new o.default.MathNode("mo", n)
                  ...
                  (f.katex = function () {
                    return new o.default.MathNode("mtext", [new o.default.TextNode("KaTeX")]);
                  }),
                  (f.font = function (e, t) {
                    var n = e.value.font;
                  ...
                  (f.delimsizing = function (e) {
                    ...
                    return (
                      "mopen" === e.value.mclass || "mclose" === e.value.mclass ? n.setAttribute("fence", "true") : n.setAttribute("fence", "false"),
                      n
                    );
                  }),
                  (f.styling = function (e, t) {
                    var n = { display: l.default.DISPLAY, text: l.default.TEXT, script: l.default.SCRIPT, scriptscript: l.default.SCRIPTSCRIPT }[
                        e.value.style
                      ],
                      r = t.havingStyle(n),
                      i = g(e.value.value, r),
                      a = new o.default.MathNode("mstyle", i),
                      s = { display: ["0", "true"], text: ["0", "false"], script: ["1", "false"], scriptscript: ["2", "false"] }[e.value.style];
                  ...
                  (f.overline = function (e, t) {
                    var n = new o.default.MathNode("mo", [new o.default.TextNode("\u203e")]);
                    n.setAttribute("stretchy", "true");
                    var r = new o.default.MathNode("mover", [v(e.value.body, t), n]);
                    return (r.setAttribute("accent", "true"), r);
                  }),
                  (f.underline = function (e, t) {
                    var n = new o.default.MathNode("mo", [new o.default.TextNode("\u203e")]);
                    n.setAttribute("stretchy", "true");
                    var r = new o.default.MathNode("munder", [v(e.value.body, t), n]);
                    return (r.setAttribute("accentunder", "true"), r);
                  }),
                  (f.accentUnder = function (e, t) {
                    var n = d.default.mathMLnode(e.value.label),
                      r = new o.default.MathNode("munder", [v(e.value.body, t), n]);
                    return (r.setAttribute("accentunder", "true"), r);
                  }),
                  (f.enclose = function (e, t) {
                    var n = new o.default.MathNode("menclose", [v(e.value.body, t)]),
                      r = "";
                  ...
                  (f.horizBrace = function (e, t) {
                    var n = d.default.mathMLnode(e.value.label);
                    return new o.default.MathNode(e.value.isOver ? "mover" : "munder", [v(e.value.base, t), n]);
                  }),
                  (f.xArrow = function (e, t) {
                    ...
                    if (e.value.body) {
                      ...
                      e.value.below
                        ? ((i = v(e.value.below, t)), (r = new o.default.MathNode("munderover", [n, i, a])))
                        : (r = new o.default.MathNode("mover", [n, a]));
                    } else
                      e.value.below
                        ? ((i = v(e.value.below, t)), (r = new o.default.MathNode("munder", [n, i])))
                  ...
                  (f.llap = function (e, t) {
                    var n = new o.default.MathNode("mpadded", [v(e.value.body, t)]);
                ...
                var g = function (e, t) {
                  ...
                  v = function (e, t) {
                    ...
                    if (f[e.type]) {
                      var r = f[e.type](e, t);
                      return n && "mrow" === r.type && 1 === r.children.length ? r.children[0] : r;
                    }
                    throw new s.default("Got group of unknown type: '" + e.type + "'");
                  },
                  b = function (e, t, n) {
                    var i = g(e, n),
                      a = new o.default.MathNode("mrow", i),
                      s = new o.default.MathNode("annotation", [new o.default.TextNode(t)]);
              ...
              function (e, t) {
                ...
                var r = n(e("./buildHTML")),
                  ...
                  u = function (e, t, n) {
                    ...
                    var c = new o.default({ style: u }),
                      d = (0, i.default)(e, t, c),
                      h = (0, r.default)(e, c),
                      p = (0, a.makeSpan)(["katex"], [d, h]);
                    return n.displayMode ? (0, a.makeSpan)(["katex-display"], [p]) : p;
                  };
                t.exports = u;
              },
              { "./Options": 28, "./Settings": 32, "./Style": 33, "./buildCommon": 34, "./buildHTML": 35, "./buildMathML": 36 },
            ],
            38: [
              function (e, t) {
                function n(e) {
                ...
                var r = n(e("./ParseError")),
                  ...
                  u = n(e("./utils")),
                  c = function (e, t) {
                    return l.default.math[e] && l.default.math[e].replace
                      ? s.default.getCharacterMetrics(l.default.math[e].replace, t)
                      : s.default.getCharacterMetrics(e, t);
                  },
                  d = function (e, t, n, r) {
                    var i = n.havingBaseStyle(t),
                      o = (0, a.makeSpan)((r || []).concat(i.sizingClasses(n)), [e], n);
                    return (
                      (o.delimSizeMultiplier = i.sizeMultiplier / n.sizeMultiplier),
                  ...
                  f = function (e, t, n, r) {
                    return o.default.makeSymbol(e, "Size" + t + "-Regular", n, r);
                  },
                  m = function (e, t, n, r, o, s) {
                    var l = f(e, t, o, r),
                      u = d((0, a.makeSpan)(["delimsizing", "size" + t], [l], r), i.default.TEXT, r, s);
                    return (n && h(u, r, i.default.TEXT), u);
                  },
                  g = function (e, t, n) {
                    var r = void 0;
                    return (
                      "Size1-Regular" === t ? (r = "delim-size1") : "Size4-Regular" === t && (r = "delim-size4"),
                      { type: "elem", elem: (0, a.makeSpan)(["delimsizinginner", r], [(0, a.makeSpan)([], [o.default.makeSymbol(e, t, n)])]) }
                    );
                  },
                  v = function (e, t, n, r, s, l) {
                      ...
                      : "\\Uparrow" === e
                        ...
                        : "\\downarrow" === e
                          ...
                          : "\\Downarrow" === e
                            ? (u = p = "\u2016")
                            : "\\updownarrow" === e
                              ? ((u = "\\uparrow"), (p = "\u23d0"), (f = "\\downarrow"))
                              : "\\Updownarrow" === e
                                ? ((u = "\\Uparrow"), (p = "\u2016"), (f = "\\Downarrow"))
                                : "[" === e || "\\lbrack" === e
                                  ? ((u = "\u23a1"), (p = "\u23a2"), (f = "\u23a3"), (m = "Size4-Regular"))
                                  : "]" === e || "\\rbrack" === e
                                    ? ((u = "\u23a4"), (p = "\u23a5"), (f = "\u23a6"), (m = "Size4-Regular"))
                                    : "\\lfloor" === e
                                      ? ((p = u = "\u23a2"), (f = "\u23a3"), (m = "Size4-Regular"))
                                      : "\\lceil" === e
                                        ? ((u = "\u23a1"), (p = f = "\u23a2"), (m = "Size4-Regular"))
                                        : "\\rfloor" === e
                                          ? ((p = u = "\u23a5"), (f = "\u23a6"), (m = "Size4-Regular"))
                                          : "\\rceil" === e
                                            ...
                                            : "(" === e
                                              ...
                                              : ")" === e
                                                ? ((u = "\u239e"), (p = "\u239f"), (f = "\u23a0"), (m = "Size4-Regular"))
                                                : "\\{" === e || "\\lbrace" === e
                                                  ? ((u = "\u23a7"), (h = "\u23a8"), (f = "\u23a9"), (p = "\u23aa"), (m = "Size4-Regular"))
                                                  : "\\}" === e || "\\rbrace" === e
                                                    ? ((u = "\u23ab"), (h = "\u23ac"), (f = "\u23ad"), (p = "\u23aa"), (m = "Size4-Regular"))
                                                    : "\\lgroup" === e
                                                      ? ((u = "\u23a7"), (f = "\u23a9"), (p = "\u23aa"), (m = "Size4-Regular"))
                                                      : "\\rgroup" === e
                                                        ? ((u = "\u23ab"), (f = "\u23ad"), (p = "\u23aa"), (m = "Size4-Regular"))
                                                        : "\\lmoustache" === e
                                                          ? ((u = "\u23a7"), (f = "\u23ad"), (p = "\u23aa"), (m = "Size4-Regular"))
                    ...
                    var E = T / 2 - N,
                      R = [];
                    if ((R.push(g(f, m, s)), null === h)) for (var L = 0; L < C; L++) R.push(g(p, m, s));
                    else {
                    ...
                    return d((0, a.makeSpan)(["delimsizing", "mult"], [D], _), i.default.TEXT, r, l);
                  },
                  b = {
                  ...
                  y = function (e, t, n) {
                    var r = o.default.makeSpan([], [], n),
                      i = n.sizeMultiplier;
                    if ("small" === t.type)
                      ((i = n.havingBaseStyle(t.style).sizeMultiplier / n.sizeMultiplier),
                        (r.height = 1 * i),
                        (r.style.height = r.height + "em"),
                        (r.surdWidth = 0.833 * i),
                        (r.innerHTML = "<svg width='100%' height='" + r.height + "em'>\n            " + b.main + "</svg>"));
                      ...
                      ((r.height = e / i), (r.style.height = r.height + "em"), (r.surdWidth = 1.056 / i));
                  ...
                  k = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"],
                  M = [0, 1.2, 1.8, 2.4, 3],
                  S = function (e, t, n, i, a) {
                    if (
                      ("<" === e || "\\lt" === e ? (e = "\\langle") : (">" !== e && "\\gt" !== e) || (e = "\\rangle"),
                      u.default.contains(x, e) || u.default.contains(k, e))
                    )
                      return m(e, t, !1, n, i, a);
                    if (u.default.contains(w, e)) return v(e, M[t], !1, n, i, a);
                  ...
                  N = function (e, t, n, r) {
                    for (var i = Math.min(2, 3 - r.style.size); i < n.length && "stack" !== n[i].type; i++) {
                      var a = c(e, T(n[i])),
                        o = a.height + a.depth;
                      if (("small" === n[i].type && (o *= r.havingBaseStyle(n[i].style).sizeMultiplier), o > t)) return n[i];
                    }
                    return n[n.length - 1];
                  },
                  E = function (e, t, n, r, i, a) {
                    "<" === e || "\\lt" === e ? (e = "\\langle") : (">" !== e && "\\gt" !== e) || (e = "\\rangle");
                    var o = void 0;
                    o = u.default.contains(k, e) ? z : u.default.contains(x, e) ? C : A;
                    var s = N(e, t, o, r);
                    return "\\surd" === e
                      ? y(t, s, r)
                      : "small" === s.type
                  ...
                  R = function (e, t, n, r, i, a) {
                    var o = r.fontMetrics().axisHeight * r.sizeMultiplier,
                      ...
                      u = Math.max(t - o, n + o),
                      c = Math.max((u / 500) * s, 2 * u - l);
                    return E(e, c, !0, r, i, a);
                  };
                t.exports = { sizedDelim: S, customSizedDelim: E, leftRightDelim: R };
              },
              { "./ParseError": 29, "./Style": 33, "./buildCommon": 34, "./fontMetrics": 41, "./symbols": 48, "./utils": 51 },
            ],
            39: [
              function (e, t) {
                function n(e) {
                ...
                var r = n(e("babel-runtime/helpers/classCallCheck")),
                  ...
                  l = (function () {
                    function e(t, n, i) {
                      ((0, r.default)(this, e),
                        ...
                        (this.attributes = {}),
                        this.innerHTML,
                        i && (i.style.isTight() && this.classes.push("mtight"), i.getColor() && (this.style.color = i.getColor())));
                    }
                    return (
                      (0, i.default)(e, [
                        {
                        ...
                        },
                        {
                          ...
                          value: function () {
                            ...
                            for (var t in ((e.className = s(this.classes)), this.style))
                        ...
                        },
                        {
                          ...
                          value: function () {
                            var e = "<span";
                            this.classes.length && ((e += ' class="'), (e += o.default.escape(s(this.classes))), (e += '"'));
                            var t = "";
                            for (var n in this.style) this.style.hasOwnProperty(n) && (t += o.default.hyphenate(n) + ":" + this.style[n] + ";");
                            for (var r in (t && (e += ' style="' + o.default.escape(t) + '"'), this.attributes))
                              Object.prototype.hasOwnProperty.call(this.attributes, r) &&
                                ((e += " " + r + '="'), (e += o.default.escape(this.attributes[r])), (e += '"'));
                  ...
                  u = (function () {
                    function e(t) {
                      ((0, r.default)(this, e), (this.children = t || []), (this.height = 0), (this.depth = 0), (this.maxFontSize = 0));
                    }
                    return (
                      (0, i.default)(e, [
                        {
                    ...
                    function e(t, n, i, o, s, l, u) {
                      ((0, r.default)(this, e),
                        ...
                        a.default.cjkRegex.test(t) &&
                          (a.default.hangulRegex.test(t) ? this.classes.push("hangul_fallback") : this.classes.push("cjk_fallback")),
                        /[\xee\xef\xed\xec]/.test(this.value) && (this.value = c[this.value]));
                    }
                    return (
                      (0, i.default)(e, [
                        {
                          ...
                          value: function (t) {
                            if (
                              ...
                              return !1;
                            for (var n in this.style) if (this.style.hasOwnProperty(n) && this.style[n] !== t.style[n]) return !1;
                            for (var r in t.style) if (t.style.hasOwnProperty(r) && this.style[r] !== t.style[r]) return !1;
                            return (
                              (this.value += t.value),
                        ...
                        },
                        {
                          ...
                          value: function () {
                            var e = document.createTextNode(this.value),
                              t = null;
                            for (var n in (this.italic > 0 && ((t = document.createElement("span")).style.marginRight = this.italic + "em"),
                            this.classes.length > 0 && ((t = t || document.createElement("span")).className = s(this.classes)),
                            this.style))
                        ...
                        },
                        {
                          ...
                          value: function () {
                            var e = !1,
                              t = "<span";
                            this.classes.length && ((e = !0), (t += ' class="'), (t += o.default.escape(s(this.classes))), (t += '"'));
                            var n = "";
                            for (var r in (this.italic > 0 && (n += "margin-right:" + this.italic + "em;"), this.style))
                              this.style.hasOwnProperty(r) && (n += o.default.hyphenate(r) + ":" + this.style[r] + ";");
                            n && ((e = !0), (t += ' style="' + o.default.escape(n) + '"'));
                ...
                t.exports = { span: l, documentFragment: u, symbolNode: d };
              },
              { "./unicodeRegexes": 49, "./utils": 51, "babel-runtime/helpers/classCallCheck": 4, "babel-runtime/helpers/createClass": 5 },
            ],
            40: [
              function (e, t) {
                function n(e) {
                ...
                function r(e, t, n) {
                  for (var r = [], i = [r], a = []; ; ) {
                    ...
                    ((l = new o.default("ordgroup", l, e.mode)), n && (l = new o.default("styling", { style: n, value: [l] }, e.mode)), r.push(l));
                    var u = e.nextToken.text;
                    if ("&" === u) e.consume();
                    else {
                      if ("\\end" === u) break;
                      if ("\\\\" !== u && "\\cr" !== u) throw new s.default("Expected & or \\\\ or \\end", e.nextToken);
                      var c = e.parseFunction();
                      (a.push(c.value.size), (r = []), i.push(r));
                    }
                  }
                  return ((t.body = i), (t.rowGaps = a), new o.default(t.type, t, e.mode));
                }
                function i(e, n, r) {
                ...
                (i(["array", "darray"], { numArgs: 1 }, function (e, t) {
                  var n = t[0],
                    i = {
                      type: "array",
                      cols: (n = n.value.map ? n.value : [n]).map(function (e) {
                        var t = e.value;
                        if (-1 !== "lcr".indexOf(t)) return { type: "align", align: t };
                        if ("|" === t) return { type: "separator", separator: "|" };
                        throw new s.default("Unknown column alignment: " + e.value, e);
                      }),
                  ...
                  i(["matrix", "pmatrix", "bmatrix", "Bmatrix", "vmatrix", "Vmatrix"], {}, function (e) {
                    ...
                    return (
                      ...
                      t && (n = new o.default("leftright", { body: [n], left: t[0], right: t[1] }, e.mode)),
                      n
                    );
                  }),
                  i(["cases", "dcases"], {}, function (e) {
                    ...
                    return ((t = r(e.parser, t, a(e.envName))), (t = new o.default("leftright", { body: [t], left: "\\{", right: "." }, e.mode)));
                  }),
                  i("aligned", {}, function (e) {
                    ...
                    t.value.body.forEach(function (e) {
                      for (var t = 1; t < e.length; t += 2) e[t].value.value[0].value.unshift(n);
                      i < e.length && (i = e.length);
                    });
                    for (var a = 0; a < i; ++a) {
                      var s = "r",
                        l = 0;
                      (a % 2 == 1 ? (s = "l") : a > 0 && (l = 2), (t.value.cols[a] = { type: "align", align: s, pregap: l, postgap: 0 }));
                    }
                    return t;
                  }),
                  i("gathered", {}, function (e) {
                    var t = { type: "array", cols: [{ type: "align", align: "c" }], addJot: !0 };
              ...
              function (e, t) {
                ...
                var r = e("./unicodeRegexes"),
                  ...
                  s = function (e, t) {
                    ...
                    e[0] in o ? (n = o[e[0]].charCodeAt(0)) : r.cjkRegex.test(e[0]) && (n = "M".charCodeAt(0));
                    var a = i.default[t][n];
                    if (a) return { depth: a[0], height: a[1], italic: a[2], skew: a[3], width: a[4] };
                  },
                  l = {},
                  u = function (e) {
                    var t = void 0;
                    if (!l[(t = e >= 5 ? 0 : e >= 3 ? 1 : 2)]) {
                      var n = (l[t] = {});
                      for (var r in a) a.hasOwnProperty(r) && (n[r] = a[r][t]);
            ...
            43: [
              function (e, t) {
                ...
                r("\\sqrt", { numArgs: 1, numOptionalArgs: 1 }, function (e, t) {
                  var n = t[0];
                ...
                (r(
                  ...
                  r("\\textcolor", { numArgs: 2, allowedInText: !0, greediness: 3, argTypes: ["color", "original"] }, function (e, t) {
                    var n = t[0],
                      r = t[1];
                    return { type: "color", color: n.value, value: s(r) };
                  }),
                  r("\\color", { numArgs: 1, allowedInText: !0, greediness: 3, argTypes: ["color"] }, null),
                  ...
                  r("\\rule", { numArgs: 2, numOptionalArgs: 1, argTypes: ["size", "size", "size"] }, function (e, t) {
                    var n = t[0],
                      r = t[1],
                      i = t[2];
                    return { type: "rule", shift: n && n.value, width: r.value, height: i.value };
                  }),
                  r(["\\kern", "\\mkern"], { numArgs: 1, argTypes: ["size"] }, function (e, t) {
                  ...
                  r(
                    ...
                    function (e, t) {
                      var n = t[0];
                      return { type: "mclass", mclass: "m" + e.funcName.substr(5), value: s(n) };
                    }
                  ),
                  r(
                    "\\stackrel",
                    ...
                    function (e, t) {
                      var n = t[0],
                        r = t[1],
                        i = new o.default("op", { type: "op", limits: !0, alwaysHandleSupSub: !0, symbol: !1, value: s(r) }, r.mode);
                      return { type: "mclass", mclass: "mrel", value: [new o.default("supsub", { base: i, sup: n, sub: null }, n.mode)] };
                    }
                  ),
                  r("\\bmod", { numArgs: 0 }, function () {
                    return { type: "mod", modType: "bmod", value: null };
                  }),
                  r(["\\pod", "\\pmod", "\\mod"], { numArgs: 1 }, function (e, t) {
                    var n = t[0];
                    return { type: "mod", modType: e.funcName.substr(1), value: s(n) };
                  }));
                var u = {
                  ...
                  d = { "\\Bbb": "\\mathbb", "\\bold": "\\mathbf", "\\frak": "\\mathfrak" };
                (r(
                  [
                    "\\blue",
                    "\\orange",
                  ...
                  function (e, t) {
                    var n = t[0];
                    return { type: "color", color: "katex-" + e.funcName.slice(1), value: s(n) };
                  }
                ),
                  r(
                    [
                  ...
                  r(["\\det", "\\gcd", "\\inf", "\\lim", "\\liminf", "\\limsup", "\\max", "\\min", "\\Pr", "\\sup"], { numArgs: 0 }, function (e) {
                    return { type: "op", limits: !0, symbol: !1, body: e.funcName };
                  }),
                  r(["\\int", "\\iint", "\\iiint", "\\oint"], { numArgs: 0 }, function (e) {
                  ...
                  r("\\mathop", { numArgs: 1 }, function (e, t) {
                    var n = t[0];
                    return { type: "op", limits: !1, symbol: !1, value: s(n) };
                  }),
                  r(
                    ...
                    function (e, t) {
                      ...
                      return { type: "genfrac", numer: n, denom: r, hasBarLine: i, leftDelim: a, rightDelim: o, size: s };
                    }
                  ),
                  r(["\\llap", "\\rlap"], { numArgs: 1, allowedInText: !0 }, function (e, t) {
                    var n = t[0];
                    return { type: e.funcName.slice(1), body: n };
                  }));
                var h = function (e, t) {
                  if (i.default.contains(c, e.value)) return e;
                  throw new a.default("Invalid delimiter: '" + e.value + "' after '" + t.funcName + "'", e);
                };
                (r(
                  [
                    "\\bigl",
                  ...
                  function (e, t) {
                    var n = h(t[0], e);
                    return { type: "delimsizing", size: u[e.funcName].size, mclass: u[e.funcName].mclass, value: n.value };
                  }
                ),
                  ...
                  r("\\middle", { numArgs: 1 }, function (e, t) {
                    var n = h(t[0], e);
                    if (!e.parser.leftrightDepth) throw new a.default("\\middle without preceding \\left", n);
                  ...
                  r(["\\displaystyle", "\\textstyle", "\\scriptstyle", "\\scriptscriptstyle"], 0, null),
                  ...
                  r(
                    ...
                    function (e, t) {
                      var n = t[0],
                        r = e.funcName;
                      return (r in d && (r = d[r]), { type: "font", font: r.slice(1), body: n });
                    }
                  ),
                  r(
                    [
                    ...
                    function (e, t) {
                      var n = t[0],
                        ...
                        a = !r || i.default.contains(["\\widehat", "\\widetilde"], e.funcName);
                      return { type: "accent", label: e.funcName, isStretchy: r, isShifty: a, value: s(n), base: n };
                    }
                  ),
                  r(
                    ["\\'", "\\`", "\\^", "\\~", "\\=", "\\u", "\\.", '\\"', "\\r", "\\H", "\\v"],
                    ...
                    function (e, t) {
                      var n = t[0];
                      return { type: "accent", label: e.funcName, isStretchy: !1, isShifty: !0, value: s(n), base: n };
                    }
                  ),
                  r(["\\overbrace", "\\underbrace"], { numArgs: 1 }, function (e, t) {
                    var n = t[0];
                    return { type: "horizBrace", label: e.funcName, isOver: /^\\over/.test(e.funcName), base: n };
                  }),
                  r(
                    ...
                    function (e, t) {
                      var n = t[0];
                      return { type: "accentUnder", label: e.funcName, value: s(n), body: n };
                    }
                  ),
                  r(
                    [
                    ...
                    function (e, t) {
                      var n = t[0],
                        r = t[1];
                      return { type: "xArrow", label: e.funcName, body: r, below: n };
                    }
                  ),
                  r(["\\cancel", "\\bcancel", "\\xcancel", "\\sout", "\\fbox"], { numArgs: 1 }, function (e, t) {
                    var n = t[0];
                    return { type: "enclose", label: e.funcName, body: n };
                  }),
                  r(["\\over", "\\choose", "\\atop"], { numArgs: 0, infix: !0 }, function (e) {
                    var t = void 0;
                    switch (e.funcName) {
                      case "\\over":
                        t = "\\frac";
                  ...
                  r(["\\\\", "\\cr"], { numArgs: 0, numOptionalArgs: 1, argTypes: ["size"] }, function (e, t) {
                    return { type: "cr", size: t[0] };
                  }),
                  r(["\\begin", "\\end"], { numArgs: 1, argTypes: ["text"] }, function (e, t) {
                    var n = t[0];
                    if ("ordgroup" !== n.type) throw new a.default("Invalid environment name", n);
            ...
            44: [
              function (e, t) {
                ...
                (n("\\bgroup", "{"),
                  ...
                  n("\\dblcolon", "\\vcentcolon\\mathrel{\\mkern-.9mu}\\vcentcolon"),
                  n("\\coloneqq", "\\vcentcolon\\mathrel{\\mkern-1.2mu}="),
                  n("\\Coloneqq", "\\dblcolon\\mathrel{\\mkern-1.2mu}="),
                  n("\\coloneq", "\\vcentcolon\\mathrel{\\mkern-1.2mu}\\mathrel{-}"),
                  n("\\Coloneq", "\\dblcolon\\mathrel{\\mkern-1.2mu}\\mathrel{-}"),
                  n("\\eqqcolon", "=\\mathrel{\\mkern-1.2mu}\\vcentcolon"),
                  n("\\Eqqcolon", "=\\mathrel{\\mkern-1.2mu}\\dblcolon"),
                  n("\\eqcolon", "\\mathrel{-}\\mathrel{\\mkern-1.2mu}\\vcentcolon"),
                  n("\\Eqcolon", "\\mathrel{-}\\mathrel{\\mkern-1.2mu}\\dblcolon"),
                  n("\\colonapprox", "\\vcentcolon\\mathrel{\\mkern-1.2mu}\\approx"),
                  n("\\Colonapprox", "\\dblcolon\\mathrel{\\mkern-1.2mu}\\approx"),
                  n("\\colonsim", "\\vcentcolon\\mathrel{\\mkern-1.2mu}\\sim"),
                  ...
                  n("\\simcolon", "\\sim\\mathrel{\\mkern-1.2mu}\\vcentcolon"),
                  n("\\simcoloncolon", "\\sim\\mathrel{\\mkern-1.2mu}\\dblcolon"),
                  n("\\approxcolon", "\\approx\\mathrel{\\mkern-1.2mu}\\vcentcolon"),
                  n("\\approxcoloncolon", "\\approx\\mathrel{\\mkern-1.2mu}\\dblcolon"));
              },
              {},
            ],
            45: [
              function (e, t) {
                ...
                var r = n(e("babel-runtime/helpers/classCallCheck")),
                  ...
                  o = (function () {
                    function e(t, n) {
                      ((0, r.default)(this, e), (this.type = t), (this.attributes = {}), (this.children = n || []));
                    }
                    return (
                      (0, i.default)(e, [
                        {
                          ...
                          value: function () {
                            ...
                            for (var t in this.attributes)
                              Object.prototype.hasOwnProperty.call(this.attributes, t) &&
                                ((e += " " + t + '="'), (e += a.default.escape(this.attributes[t])), (e += '"'));
                            e += ">";
            ...
            47: [
              function (e, t) {
                var n = e("./buildCommon"),
                  ...
                  o = function (e) {
                    var t = new r.MathNode("mo", [new r.TextNode(a[e.substr(1)])]);
                  ...
                  u = {
                    ...
                    doubleleftrightarrow:
                      ...
                      l.doublerightarrow +
                      "</svg>",
                    doublerightarrow: "><svg viewBox='0 0 400000 549'\npreserveAspectRatio='xMaxYMin slice'>" + l.doublerightarrow + "</svg>",
                    hookleftarrow:
                  ...
                  c = function (e, t) {
                    var r = e.value.label.substr(1),
                      ...
                      l = "",
                      c = 0;
                    if (i.contains(["widehat", "widetilde", "undertilde"], r)) {
                      var d = e.value.value.length;
                      if (d > 5) ((a = 0.312), (l = ("widehat" === r ? "widehat" : "tilde") + "4"));
                      else {
                        var h = [1, 1, 2, 2, 3, 3][d];
                        "widehat" === r
                          ? ((a = [0, 0.24, 0.3, 0.3, 0.36, 0.36][d]), (l = "widehat" + h))
                          : ((a = [0, 0.26, 0.3, 0.3, 0.34, 0.34][d]), (l = "tilde" + h));
                      }
                    } else {
                      var p = s[r];
                      ((a = p[0]), (o = p[1]), (l = p[2]), (c = p[3]));
                    }
                    var f = n.makeSpan([], [], t);
                    ...
                    return (
                      (f.style.height = m + "em"),
                      c > 0 && (f.style.minWidth = c + "em"),
                      (f.innerHTML = "<svg width='100%' height='" + m + "em'" + u[l] + "</svg>"),
                      f
                    );
                  },
                  d = function (e, t, r, i) {
                    ...
                    return (
                      "fbox" === t
                        ? ((a = n.makeSpan(["stretchy", t], [], i)), i.color && (a.style.borderColor = i.getColor()))
                        : ((a = n.makeSpan([], [], i)).innerHTML = "<svg width='100%' height='" + o + "em'>" + u[t] + "</svg>"),
                      (a.height = o),
                      (a.style.height = o + "em"),
                      a
                    );
                  };
                t.exports = { encloseSpan: d, mathMLnode: o, svgSpan: c };
              },
            ...
            48: [
              function (e, t) {
                function n(e, n, r, i, a, o) {
                  ((t.exports[e][a] = { font: n, group: r, replace: i }), o && (t.exports[e][i] = t.exports[e][a]));
                }
                t.exports = { math: {}, text: {} };
                var r = "math",
                  i = "text",
                ...
                (n(r, a, m, "\u2261", "\\equiv"),
                  ...
                  n(r, a, d, "\u03c8", "\\psi", !0),
                  n(r, a, d, "\u03c9", "\\omega", !0),
                  n(r, a, d, "\u03b5", "\\varepsilon", !0),
                  n(r, a, d, "\u03d1", "\\vartheta", !0),
                  n(r, a, d, "\u03d6", "\\varpi", !0),
                  n(r, a, d, "\u03f1", "\\varrho", !0),
                  n(r, a, d, "\u03c2", "\\varsigma", !0),
                  n(r, a, d, "\u03c6", "\\varphi", !0),
                  n(r, a, l, "\u2217", "*"),
                  n(r, a, l, "+", "+"),
                  n(r, a, l, "\u2212", "-"),
                  ...
                  n(i, a, v, "\xb0", "\\degree"),
                  n(r, a, d, "\xa3", "\\pounds"),
                  n(r, a, d, "\xa3", "\\mathsterling"),
                  n(i, a, d, "\xa3", "\\pounds"),
                  n(i, a, d, "\xa3", "\\textsterling"),
                  n(r, o, v, "\u2720", "\\maltese"),
                  n(i, o, v, "\u2720", "\\maltese"),
                  n(i, a, g, "\xa0", "\\ "),
                  n(i, a, g, "\xa0", " "),
                ...
                for (var w = '0123456789!@*()-=+[]<>|";:?/.,', k = 0; k < w.length; k++) {
                  var M = w.charAt(k);
                  n(i, a, v, M, M);
                }
                for (var S = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", z = 0; z < S.length; z++) {
                  var A = S.charAt(z);
                  (n(r, a, d, A, A), n(i, a, v, A, A));
                }
                for (var C = 192; C <= 214; C++) {
                  var T = String.fromCharCode(C);
                  (n(r, a, d, T, T), n(i, a, v, T, T));
                }
                for (var N = 216; N <= 246; N++) {
                  var E = String.fromCharCode(N);
                  (n(r, a, d, E, E), n(i, a, v, E, E));
                }
                for (var R = 248; R <= 255; R++) {
                  var L = String.fromCharCode(R);
                  (n(r, a, d, L, L), n(i, a, v, L, L));
                }
            ...
            50: [
              function (e, t) {
                ...
                var r = n(e("./ParseError")),
                  ...
                  a = { ex: !0, em: !0, mu: !0 },
                  o = function (e) {
                    return (e.unit && (e = e.unit), e in i || e in a || "ex" === e);
                  },
                  s = function (e, t) {
                    var n = void 0;
                    if (e.unit in i) n = i[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
                    else if ("mu" === e.unit) n = t.fontMetrics().cssEmPerMu;
                    else {
                      var a = void 0;
                      if (((a = t.style.isTight() ? t.havingStyle(t.style.text()) : t), "ex" === e.unit)) n = a.fontMetrics().xHeight;
                      else {
                        if ("em" !== e.unit) throw new r.default("Invalid unit: '" + e.unit + "'");
            ...
            51: [
              function (e, t) {
                ...
                t.exports = { contains: s, deflt: l, escape: r, hyphenate: c, indexOf: o, setTextContent: p, clearNode: i };
              },
              {},
            ],
          },
  ...
  const oe = function (e, t, n) {
      ...
      for (let a = 0; a < e.length; a++)
        if ("text" === e[a].type) {
          ...
          let s,
            l = !0,
            u = 0;
          for (s = o.indexOf(t), -1 !== s && ((u = s), i.push({ type: "text", data: o.slice(0, u) }), (l = !1)); ; ) {
            if (l) {
              if (((s = o.indexOf(t, u)), -1 === s)) break;
              (i.push({ type: "text", data: o.slice(u, s) }), (u = s));
            } else {
              if (((s = oe(n, o, u + t.length)), -1 === s)) break;
              (i.push({ type: "math", data: o.slice(u + t.length, s), rawData: o.slice(u, s + n.length), display: r }), (u = s + n.length));
            }
            l = !l;
          }
    ...
    le = function (e, t) {
      ...
      for (let e = 0; e < t.length; e++) {
        const r = t[e];
        n = se(n, r.left, r.right, r.display || !1);
      }
      return n;
    },
    ue = function (e, t) {
      const n = le(e, t.delimiters),
        r = document.createDocumentFragment();
      for (let e = 0; e < n.length; e++)
        if ("text" === n[e].type) r.appendChild(document.createTextNode(n[e].data));
        else {
          const i = document.createElement("d-math"),
            a = n[e].data;
          t.displayMode = n[e].display;
          try {
            ((i.textContent = a), t.displayMode && i.setAttribute("block", ""));
          } catch (i) {
            if (!(i instanceof katex.ParseError)) throw i;
            (t.errorCallback("KaTeX auto-render: Failed to parse `" + n[e].data + "` with ", i),
    ...
    ce = function (e, t) {
      for (let n = 0; n < e.childNodes.length; n++) {
        ...
        if (3 === r.nodeType) {
          ...
          -1 === t.ignoredTags.indexOf(r.nodeName.toLowerCase()) && ce(r, t);
        }
      }
    },
    de = {
  ...
  const xe = `\n<style>\ndistill-header {\n  position: relative;\n  height: 60px;\n  background-color: hsl(200, 60%, 15%);\n  width: 100%;\n  box-sizing: border-box;\n  z-index: 2;\n  color: rgba(0, 0, 0, 0.8);\n  border-bottom: 1px solid rgba(0, 0, 0, 0.08);\n  box-shadow: 0 1px 6px rgba(0, 0, 0, 0.05);\n}\ndistill-header .content {\n  height: 70px;\n  grid-column: page;\n}\ndistill-header a {\n  font-size: 16px;\n  height: 60px;\n  line-height: 60px;\n  text-decoration: none;\n  color: rgba(255, 255, 255, 0.8);\n  padding: 22px 0;\n}\ndistill-header a:hover {\n  color: rgba(255, 255, 255, 1);\n}\ndistill-header svg {\n  width: 24px;\n  position: relative;\n  top: 4px;\n  margin-right: 2px;\n}\n@media(min-width: 1080px) {\n  distill-header {\n    height: 70px;\n  }\n  distill-header a {\n    height: 70px;\n    line-height: 70px;\n    padding: 28px 0;\n  }\n  distill-header .logo {\n  }\n}\ndistill-header svg path {\n  fill: none;\n  stroke: rgba(255, 255, 255, 0.8);\n  stroke-width: 3px;\n}\ndistill-header .logo {\n  font-size: 17px;\n  font-weight: 200;\n}\ndistill-header .nav {\n  float: right;\n  font-weight: 300;\n}\ndistill-header .nav a {\n  font-size: 12px;\n  margin-left: 24px;\n  text-transform: uppercase;\n}\n</style>\n<div class="content">\n  <a href="/" class="logo">\n    ${ye}\n    Distill\n  </a>\n  <nav class="nav">\n    <a href="/about/">About</a>\n    <a href="/prize/">Prize</a>\n    <a href="/journal/">Submit</a>\n  </nav>\n</div>\n`,
    ...
    Ae = { extractors: Me, transforms: Se, distillTransforms: ze };
  ((e.FrontMatter = ne),
    (e.distillify = G),
    (e.render = V),
    (e.testing = Ae),
